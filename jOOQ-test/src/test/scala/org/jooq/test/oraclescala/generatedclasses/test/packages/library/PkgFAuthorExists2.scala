 ...
 * This class is generated by jOOQ.
 */
class PkgFAuthorExists2 extends AbstractRoutine[BigDecimal]("PKG_F_AUTHOR_EXISTS", Test.TEST, Library.LIBRARY, org.jooq.impl.SQLDataType.NUMERIC) {
	{
		setReturnParameter(PkgFAuthorExists2.RETURN_VALUE)
		addInParameter(PkgFAuthorExists2.AUTHOR_NAME)
		addInParameter(PkgFAuthorExists2.UNUSED)
		setOverloaded(true)
	}
	...
	def setAuthorName(value : String) : Unit = {
		setValue(PkgFAuthorExists2.AUTHOR_NAME, value)
	}
	...
	def setAuthorName(field : Field[String]) : Unit = {
		setField(PkgFAuthorExists2.AUTHOR_NAME, field)
	}
	...
	def setUnused(value : Number) : Unit = {
		setNumber(PkgFAuthorExists2.UNUSED, value)
	}

	/**
	 * Set the <code>UNUSED</code> parameter to the function to be used with a {@link org.jooq.Select} statement
	 */
	def setUnused(field : Field[_ <: Number]) : Unit = {
		setNumber(PkgFAuthorExists2.UNUSED, field)
	}
}
