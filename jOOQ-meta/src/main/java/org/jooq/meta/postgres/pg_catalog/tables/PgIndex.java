...
public class PgIndex extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Object[]> INDKEY = createField(DSL.name("indkey"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").array().nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_index.indcollation</code>.
     */
    public final TableField<Record, Object[]> INDCOLLATION = createField(DSL.name("indcollation"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").array().nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_index.indclass</code>.
     */
    public final TableField<Record, Object[]> INDCLASS = createField(DSL.name("indclass"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"idvector\"").array().nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_index.indoption</code>.
     */
    public final TableField<Record, Object[]> INDOPTION = createField(DSL.name("indoption"), DefaultDataType.getDefaultDataType("\"pg_catalog\".\"nt2vector\"").array().nullable(false), this, "");
