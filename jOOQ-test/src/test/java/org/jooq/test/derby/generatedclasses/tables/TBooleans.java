...
public class TBooleans extends org.jooq.impl.TableImpl<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord> {
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_10> ONE_ZERO = createField("ONE_ZERO", org.jooq.impl.SQLDataType.INTEGER, T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_10_Converter());
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_YN_LC> Y_N_LC = createField("Y_N_LC", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_YN_LC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.Y_N_UC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_YN_UC> Y_N_UC = createField("Y_N_UC", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_YN_UC_Converter());
	...
	private TBooleans(java.lang.String alias, org.jooq.Table<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord> aliased) {
		this(alias, aliased, null);
	}

	private TBooleans(java.lang.String alias, org.jooq.Table<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord> aliased, org.jooq.Field<?>[] parameters) {
