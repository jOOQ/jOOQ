...
public interface MockDataProvider {
     ...
     * requested from this execution, you can also add an additional
     * {@link MockResult} containing {@link MockResult#data} to your result, in
     * addition to the affected {@link MockResult#rows}. The relevant flag is
     * passed from <code>MockStatement</code> to any of these properties:
     * <ul>
