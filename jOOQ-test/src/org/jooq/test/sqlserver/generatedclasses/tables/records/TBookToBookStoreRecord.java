...
public class TBookToBookStoreRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.sqlserver.generatedclasses.tables.records.TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = 1762510877;
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.sqlserver.generatedclasses.tables.records.TBookStoreRecord fetchTBookStore() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.sqlserver.generatedclasses.tables.records.TBookStoreRecord getTBookStore() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.sqlserver.generatedclasses.tables.TBookStore.T_BOOK_STORE)
			.where(org.jooq.test.sqlserver.generatedclasses.tables.TBookStore.NAME.equal(getValue(org.jooq.test.sqlserver.generatedclasses.tables.TBookToBookStore.BOOK_STORE_NAME)))
			.fetchOne();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.sqlserver.generatedclasses.tables.records.TBookRecord fetchTBook() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.sqlserver.generatedclasses.tables.records.TBookRecord getTBook() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.sqlserver.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.sqlserver.generatedclasses.tables.TBook.ID.equal(getValue(org.jooq.test.sqlserver.generatedclasses.tables.TBookToBookStore.BOOK_ID)))
			.fetchOne();
	...
	public TBookToBookStoreRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.sqlserver.generatedclasses.tables.TBookToBookStore.T_BOOK_TO_BOOK_STORE, configuration);
	}
}
