...
public class GetWkt extends org.jooq.impl.AbstractRoutine<java.lang.String> {

	private static final long serialVersionUID = -1215919539;

	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_WKT.RETURN_VALUE</code>.
	 */
	public static final org.jooq.Parameter<java.lang.String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.CLOB, false);

	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_WKT.SELF</code>.
	 */
	 ...
	 */
	public GetWkt() {
		super("GET_WKT", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY, org.jooq.impl.SQLDataType.CLOB);
	...
	public void setSelf(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.GetWkt.SELF, value);
	}
