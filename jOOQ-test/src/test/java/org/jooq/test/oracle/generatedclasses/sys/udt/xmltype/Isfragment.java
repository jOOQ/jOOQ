...
public class Isfragment extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 629240897;

	/**
	 * The parameter <code>SYS.XMLTYPE.ISFRAGMENT.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.ISFRAGMENT.SELF</code>.
	 */
	 ...
	 */
	public Isfragment() {
		super("ISFRAGMENT", Sys.SYS, Xmltype.XMLTYPE, org.jooq.impl.SQLDataType.NUMERIC);
