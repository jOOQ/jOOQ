...
/**
 * This provider is used for the {@link Insert}'s DSL API
 *
 * @author Timur Shaidullin
 */
public interface OnConflictProvider extends QueryPart {
    /**
     * Add conflict target to <code>ON CONFLICT</code> clause
     * to this query.
     */
     ...
     */
    @Support({ POSTGRES_9_5 })
    void addOnConflict(Field<?> field);
    /**
