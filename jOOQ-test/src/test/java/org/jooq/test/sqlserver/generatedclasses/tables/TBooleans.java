...
public class TBooleans extends org.jooq.impl.TableImpl<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord> {
	 ...
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_10> ONE_ZERO = createField("one_zero", org.jooq.impl.SQLDataType.INTEGER, this, "", new org.jooq.test._.converters.Boolean_10_Converter());

	/**
	 * The column <code>dbo.t_booleans.true_false_lc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_TF_LC> TRUE_FALSE_LC = createField("true_false_lc", org.jooq.impl.SQLDataType.VARCHAR.length(5), this, "", new org.jooq.test._.converters.Boolean_TF_LC_Converter());

	/**
	 * The column <code>dbo.t_booleans.true_false_uc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_TF_UC> TRUE_FALSE_UC = createField("true_false_uc", org.jooq.impl.SQLDataType.VARCHAR.length(5), this, "", new org.jooq.test._.converters.Boolean_TF_UC_Converter());

	/**
	 * The column <code>dbo.t_booleans.yes_no_lc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YES_NO_LC> YES_NO_LC = createField("yes_no_lc", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "", new org.jooq.test._.converters.Boolean_YES_NO_LC_Converter());

	/**
	 * The column <code>dbo.t_booleans.yes_no_uc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YES_NO_UC> YES_NO_UC = createField("yes_no_uc", org.jooq.impl.SQLDataType.VARCHAR.length(3), this, "", new org.jooq.test._.converters.Boolean_YES_NO_UC_Converter());

	/**
	 * The column <code>dbo.t_booleans.y_n_lc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YN_LC> Y_N_LC = createField("y_n_lc", org.jooq.impl.SQLDataType.CHAR.length(1), this, "", new org.jooq.test._.converters.Boolean_YN_LC_Converter());

	/**
	 * The column <code>dbo.t_booleans.y_n_uc</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.sqlserver.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YN_UC> Y_N_UC = createField("y_n_uc", org.jooq.impl.SQLDataType.CHAR.length(1), this, "", new org.jooq.test._.converters.Boolean_YN_UC_Converter());
