...
public class TBooleansDao extends org.jooq.impl.DAOImpl<org.jooq.test.oracle.generatedclasses.test.tables.records.TBooleansRecord, org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans, java.lang.Integer> {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByOneZero(org.jooq.test.all.converters.Boolean_10... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByTrueFalseLc(org.jooq.test.all.converters.Boolean_TF_LC... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByTrueFalseUc(org.jooq.test.all.converters.Boolean_TF_UC... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByYesNoLc(org.jooq.test.all.converters.Boolean_YES_NO_LC... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByYesNoUc(org.jooq.test.all.converters.Boolean_YES_NO_UC... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByYNLc(org.jooq.test.all.converters.Boolean_YN_LC... values) {
	 ...
	 */
	public java.util.List<org.jooq.test.oracle.generatedclasses.test.tables.pojos.TBooleans> fetchByYNUc(org.jooq.test.all.converters.Boolean_YN_UC... values) {
