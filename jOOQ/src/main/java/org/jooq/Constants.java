...
public final class Constants {
     ...
     * version suffixes.
     */
    public static final String VERSION        = "3.12.5-SNAPSHOT";
     ...
     */
    public static final String FULL_VERSION   = "3.12.5-SNAPSHOT";

    /**
     * The current jooq-runtime XSD file name.
     */
    public static final String XSD_RUNTIME    = "jooq-runtime-3.12.4.xsd";
