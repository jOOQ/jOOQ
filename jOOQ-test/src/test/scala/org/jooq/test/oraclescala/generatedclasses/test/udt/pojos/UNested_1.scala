...
class UNested_1(
	...
	, private var nested : List[Integer]
	...
	def getNested : List[Integer] = {
		this.nested
	}

	def setNested(nested : List[Integer]) : Unit = {
		this.nested = nested
	}
	...
	override def equals(obj : Any) : scala.Boolean = {
		...
		if (getClass() != obj.getClass())
			return false
		val other = obj.asInstanceOf[UNested_1]
		if (id == null) {
			if (other.id != null)
				return false
		}
