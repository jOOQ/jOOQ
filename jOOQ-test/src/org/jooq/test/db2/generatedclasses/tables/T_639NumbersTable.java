...
public class T_639NumbersTable extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord> {

	private static final long serialVersionUID = -1820615882;

	/**
	 * The singleton instance of <code>LIBRARY.T_639_NUMBERS_TABLE</code>
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.ID</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_639_NUMBERS_TABLE, "");

	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.SHORT</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.INTEGER</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.LONG</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.BYTE_DECIMAL</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.SHORT_DECIMAL</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.INTEGER_DECIMAL</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.LONG_DECIMAL</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.BIG_INTEGER</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord, java.math.BigInteger> BIG_INTEGER = createField("BIG_INTEGER", org.jooq.impl.SQLDataType.DECIMAL_INTEGER.precision(22), T_639_NUMBERS_TABLE, "");

	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.BIG_DECIMAL</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord, java.math.BigDecimal> BIG_DECIMAL = createField("BIG_DECIMAL", org.jooq.impl.SQLDataType.DECIMAL.precision(22, 5), T_639_NUMBERS_TABLE, "");

	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.FLOAT</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_639_NUMBERS_TABLE.DOUBLE</code>.
	 */
	...
	private T_639NumbersTable(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord> aliased) {
		this(alias, aliased, null);
	}

	private T_639NumbersTable(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.T_639NumbersTableRecord> getPrimaryKey() {
