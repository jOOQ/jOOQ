...
public class PaymentP2007_01 extends TableImpl<PaymentP2007_01Record> {
    ...
    private static final long serialVersionUID = -999879315;
     ...
     */
    public final TableField<PaymentP2007_01Record, Integer> PAYMENT_ID = createField("payment_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('payment_payment_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<PaymentP2007_01Record, BigDecimal> AMOUNT = createField("amount", org.jooq.impl.SQLDataType.NUMERIC(5, 2).nullable(false), this, "");
