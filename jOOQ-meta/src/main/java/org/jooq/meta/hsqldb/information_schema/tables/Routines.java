...
public class Routines extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Timestamp> CREATED = createField(DSL.name("CREATED"), SQLDataType.TIMESTAMP(6), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.ROUTINES.LAST_ALTERED</code>.
     */
    public final TableField<Record, Timestamp> LAST_ALTERED = createField(DSL.name("LAST_ALTERED"), SQLDataType.TIMESTAMP(6), this, "");
