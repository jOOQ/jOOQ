...
object P2155 {
	 ...
	 */
	val P5 : Parameter[LocalDateTime] = AbstractRoutine.createParameter("P5", org.jooq.impl.SQLDataType.DATE, false, new LocalDateTimeConverter)
}
