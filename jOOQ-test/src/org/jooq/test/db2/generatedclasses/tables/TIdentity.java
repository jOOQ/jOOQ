...
public class TIdentity extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord> {
	...
	private static final long serialVersionUID = -592904161;

	/**
	 * The singleton instance of <code>LIBRARY.T_IDENTITY</code>
	 */
	...
	public java.lang.Class<org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord> getRecordType() {
		return org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord.class;
	}

	/**
	 * The column <code>LIBRARY.T_IDENTITY.ID</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_IDENTITY, "");

	/**
	 * The column <code>LIBRARY.T_IDENTITY.VAL</code>.
	 */
	...
	private TIdentity(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord> aliased) {
		this(alias, aliased, null);
	}

	private TIdentity(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.TIdentityRecord> aliased, org.jooq.Field<?>[] parameters) {
