...
public class SdoPolyXor extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = -481699355;
	 ...
	 */
	public SdoPolyXor() {
		super("SDO_POLY_XOR", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
