...
public class XTestCase_85Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.sqlserver.generatedclasses.tables.records.XTestCase_85Record> {
	...
	private static final long serialVersionUID = 901755026;
	 ...
	 */
	@Deprecated
	public org.jooq.test.sqlserver.generatedclasses.tables.records.XUnusedRecord getXUnused() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.sqlserver.generatedclasses.tables.XUnused.X_UNUSED)
			.where(org.jooq.test.sqlserver.generatedclasses.tables.XUnused.ID.equal(getValue(org.jooq.test.sqlserver.generatedclasses.tables.XTestCase_85.X_UNUSED_ID)))
			.and(org.jooq.test.sqlserver.generatedclasses.tables.XUnused.NAME.equal(getValue(org.jooq.test.sqlserver.generatedclasses.tables.XTestCase_85.X_UNUSED_NAME)))
