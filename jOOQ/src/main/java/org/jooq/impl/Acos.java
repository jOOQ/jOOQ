    ...
    MAcos
{
    ...
    @Override
    public final MAcos $number(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MAcos> constructor() {
        return (a1) -> new Acos((Field<? extends Number>) a1);
    }
