...
public class ObjectFactory {
    ...
    private final static QName _Settings_QNAME = new QName("http://www.jooq.org/xsd/jooq-runtime-3.20.1.xsd", "settings");
     ...
     */
    @XmlElementDecl(namespace = "http://www.jooq.org/xsd/jooq-runtime-3.20.1.xsd", name = "settings")
