...
public class T_639NumbersTableRecord extends UpdatableRecordImpl<T_639NumbersTableRecord> implements Record13<Integer, Byte, Short, Integer, Long, Byte, Short, Integer, Long, BigInteger, BigDecimal, Float, Double> {

	private static final long serialVersionUID = 772078008;
	 ...
	 */
	@Column(name = "INTEGER", precision = 10)
	 ...
	 */
	@Column(name = "FLOAT", precision = 24)
	 ...
	 */
	@Column(name = "DOUBLE", precision = 53)
