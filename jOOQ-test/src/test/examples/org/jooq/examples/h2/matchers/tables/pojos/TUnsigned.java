...
public class TUnsigned implements org.jooq.examples.h2.matchers.tables.interfaces.ITUnsigned {

	private static final long serialVersionUID = -1209696978;
	 ...
	 */
	@Override
	public void from(org.jooq.examples.h2.matchers.tables.interfaces.ITUnsigned from) {
	 ...
	 */
	@Override
	public <E extends org.jooq.examples.h2.matchers.tables.interfaces.ITUnsigned> E into(E into) {
		into.from(this);
		return into;
	}
}
