...
public class XTestCase_64_69Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.sqlserver.generatedclasses.tables.records.XTestCase_64_69Record> {
	...
	private static final long serialVersionUID = -2030459269;
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.sqlserver.generatedclasses.tables.records.XTestCase_71Record> getXTestCase_71List() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.sqlserver.generatedclasses.tables.XTestCase_71.X_TEST_CASE_71)
			.where(org.jooq.test.sqlserver.generatedclasses.tables.XTestCase_71.TEST_CASE_64_69_ID.equal(getValue(org.jooq.test.sqlserver.generatedclasses.tables.XTestCase_64_69.ID)))
			.fetch();
