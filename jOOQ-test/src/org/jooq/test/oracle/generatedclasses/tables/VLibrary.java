...
public class VLibrary extends org.jooq.impl.TableImpl<org.jooq.test.oracle.generatedclasses.tables.records.VLibraryRecord> {
	...
	private static final long serialVersionUID = 1937831841;
	 ...
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.jooq.test.oracle.generatedclasses.tables.records.VLibraryRecord, java.lang.String> AUTHOR = createField("AUTHOR", org.jooq.impl.SQLDataType.VARCHAR, this);

	/**
	 * An uncommented item
	 */
	public final org.jooq.TableField<org.jooq.test.oracle.generatedclasses.tables.records.VLibraryRecord, java.lang.String> TITLE = createField("TITLE", org.jooq.impl.SQLDataType.VARCHAR, this);
	...
	private VLibrary(java.lang.String alias) {
		super(alias, org.jooq.test.oracle.generatedclasses.Test.TEST, org.jooq.test.oracle.generatedclasses.tables.VLibrary.V_LIBRARY);
	}

	@Override
	public org.jooq.test.oracle.generatedclasses.tables.VLibrary as(java.lang.String alias) {
		return new org.jooq.test.oracle.generatedclasses.tables.VLibrary(alias);
	}
}
