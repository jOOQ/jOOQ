...
public class Columns extends org.jooq.impl.TableImpl<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord> {
	...
	private static final long serialVersionUID = 1527921220;
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, org.joou.ULong> ORDINAL_POSITION = createField("ORDINAL_POSITION", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, COLUMNS);
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, org.joou.ULong> CHARACTER_MAXIMUM_LENGTH = createField("CHARACTER_MAXIMUM_LENGTH", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, org.joou.ULong> CHARACTER_OCTET_LENGTH = createField("CHARACTER_OCTET_LENGTH", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, org.joou.ULong> NUMERIC_PRECISION = createField("NUMERIC_PRECISION", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, org.joou.ULong> NUMERIC_SCALE = createField("NUMERIC_SCALE", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, COLUMNS);
