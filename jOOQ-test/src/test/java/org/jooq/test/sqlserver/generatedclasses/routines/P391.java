...
public class P391 extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -1003564606;

	/**
	 * The parameter <code>dbo.p391.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public P391() {
		super("p391", Dbo.DBO, org.jooq.impl.SQLDataType.INTEGER);
