...
public class Routines extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -289213494;
	...
	public Routines(java.lang.String alias) {
		this(alias, org.jooq.util.sqlserver.information_schema.tables.Routines.ROUTINES);
	}
	...
	public org.jooq.util.sqlserver.information_schema.tables.Routines as(java.lang.String alias) {
		return new org.jooq.util.sqlserver.information_schema.tables.Routines(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.sqlserver.information_schema.tables.Routines rename(java.lang.String name) {
		return new org.jooq.util.sqlserver.information_schema.tables.Routines(name, null);
	}
}
