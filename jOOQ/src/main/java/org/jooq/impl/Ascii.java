    ...
    MAscii
{
    ...
    @Override
    public final MAscii $string(MField<String> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<String>, ? extends MAscii> constructor() {
        return (a1) -> new Ascii((Field<String>) a1);
    }
