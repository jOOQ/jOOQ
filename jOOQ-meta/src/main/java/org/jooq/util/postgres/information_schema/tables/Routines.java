...
public class Routines extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1143957308;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.Record, java.lang.Integer> RESULT_CAST_INTERVAL_PRECISION = createField("result_cast_interval_precision", org.jooq.impl.SQLDataType.INTEGER, this, "");
	...
	public Routines(java.lang.String alias) {
		this(alias, org.jooq.util.postgres.information_schema.tables.Routines.ROUTINES);
	}
	...
	public org.jooq.util.postgres.information_schema.tables.Routines as(java.lang.String alias) {
		return new org.jooq.util.postgres.information_schema.tables.Routines(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.postgres.information_schema.tables.Routines rename(java.lang.String name) {
		return new org.jooq.util.postgres.information_schema.tables.Routines(name, null);
	}
}
