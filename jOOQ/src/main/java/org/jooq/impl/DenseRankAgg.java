...
extends
    AbstractAggregateFunction<Integer, QOM.DenseRankAgg>
implements
    QOM.DenseRankAgg
{
    ...
    @Override
    final QOM.DenseRankAgg copyAggregateFunction(Function<? super QOM.DenseRankAgg, ? extends QOM.DenseRankAgg> function) {
