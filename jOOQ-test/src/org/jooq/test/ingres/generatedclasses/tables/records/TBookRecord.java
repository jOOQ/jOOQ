...
public class TBookRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = 1864224554;
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.ingres.generatedclasses.tables.records.TAuthorRecord fetchTAuthorByAuthorId() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.ingres.generatedclasses.tables.records.TAuthorRecord getTAuthorByAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TAuthor.T_AUTHOR)
			.where(org.jooq.test.ingres.generatedclasses.tables.TAuthor.ID.equal(getValue(org.jooq.test.ingres.generatedclasses.tables.TBook.AUTHOR_ID)))
			.fetchOne();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.ingres.generatedclasses.tables.records.TAuthorRecord fetchTAuthorByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TAuthor.T_AUTHOR)
	 ...
	 */
	@Deprecated
	public org.jooq.test.ingres.generatedclasses.tables.records.TAuthorRecord getTAuthorByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TAuthor.T_AUTHOR)
			.where(org.jooq.test.ingres.generatedclasses.tables.TAuthor.ID.equal(getValue(org.jooq.test.ingres.generatedclasses.tables.TBook.CO_AUTHOR_ID)))
			.fetchOne();
	...
	public TBookRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.ingres.generatedclasses.tables.TBook.T_BOOK, configuration);
	}
}
