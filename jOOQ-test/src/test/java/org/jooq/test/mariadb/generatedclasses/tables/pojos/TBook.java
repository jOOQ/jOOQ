...
public class TBook implements java.io.Serializable {
	...
	private static final long serialVersionUID = -1121056221;
	...
	private final org.jooq.test.mariadb.generatedclasses.enums.TBookStatus status;
	...
	public TBook(
		...
		byte[]                                                   contentPdf,
		org.jooq.test.mariadb.generatedclasses.enums.TBookStatus status
	) {
		this.id = id;
	...
	public org.jooq.test.mariadb.generatedclasses.enums.TBookStatus getStatus() {
		return this.status;
	}
}
