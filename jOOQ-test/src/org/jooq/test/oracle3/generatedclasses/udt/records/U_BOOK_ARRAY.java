 ...
 * This class is generated by jOOQ.
 */
public class U_BOOK_ARRAY extends org.jooq.impl.ArrayRecordImpl<org.jooq.test.oracle3.generatedclasses.udt.records.U_BOOK_TYPE> {

	private static final long serialVersionUID = -1508952656;

	public U_BOOK_ARRAY(org.jooq.Configuration configuration) {
		super("TEST.U_BOOK_ARRAY", org.jooq.test.oracle3.generatedclasses.udt.U_BOOK_TYPE.U_BOOK_TYPE.getDataType(), configuration);
	}
