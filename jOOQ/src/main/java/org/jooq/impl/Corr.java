    ...
    MCorr
{
    ...
    @Override
    public final MCorr $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MCorr $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MCorr> constructor() {
        return (a1, a2) -> new Corr((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof Corr) {
            return
                StringUtils.equals($y(), ((Corr) that).$y()) &&
                StringUtils.equals($x(), ((Corr) that).$x())
            ;
        }
        else
