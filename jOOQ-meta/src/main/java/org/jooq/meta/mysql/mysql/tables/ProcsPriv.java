...
public class ProcsPriv extends TableImpl<Record> {
     ...
     */
    public static final TableField<Record, ProcsPrivRoutineType> ROUTINE_TYPE = createField("Routine_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcsPrivRoutineType.class), PROCS_PRIV, "");
