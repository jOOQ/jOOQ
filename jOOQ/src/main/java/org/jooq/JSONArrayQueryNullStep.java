...
public interface JSONArrayQueryNullStep<T> extends JSONArrayQueryReturningStep<T> {
    ...
    JSONArrayQueryReturningStep<T> nullOnNull();
     ...
     */
    @Support({ DUCKDB, H2, MARIADB, POSTGRES, SQLITE, TRINO, YUGABYTEDB })
    @NotNull @CheckReturnValue
    JSONArrayQueryReturningStep<T> absentOnNull();
}
