...
public class XTestCase_64_69Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ase.generatedclasses.tables.records.XTestCase_64_69Record> {
	...
	private static final long serialVersionUID = 606425134;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ase.generatedclasses.tables.records.XTestCase_71Record> fetchXTestCase_71List() throws java.sql.SQLException {
		return create()
	...
	public XTestCase_64_69Record(org.jooq.Configuration configuration) {
		super(org.jooq.test.ase.generatedclasses.tables.XTestCase_64_69.X_TEST_CASE_64_69, configuration);
	}
}
