...
public class VAuthorRecord extends TableRecordImpl<VAuthorRecord> implements Record6<Long, String, String, Date, Long, String>, IVAuthor {

	private static final long serialVersionUID = 1782904828;
	 ...
	 */
	@Override
	public VAuthorRecord value1(Long value) {
		setId(value);
		return this;
	}
	 ...
	 */
	@Override
	public VAuthorRecord value5(Long value) {
	 ...
	 */
	@Override
	public VAuthorRecord values(Long value1, String value2, String value3, Date value4, Long value5, String value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public VAuthorRecord(Long id, String firstName, String lastName, Date dateOfBirth, Long yearOfBirth, String address) {
		super(VAuthor.V_AUTHOR);
