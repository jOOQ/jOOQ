...
// [jooq-tools] END [merge]
     ...
     */
    @Support({ CUBRID, DB2, DERBY, FIREBIRD, H2, HANA, HSQLDB, INGRES, ORACLE, POSTGRES, SQLSERVER2012, SYBASE })
     ...
     */
    @Support({ CUBRID, DB2, FIREBIRD, H2, HSQLDB, INGRES, ORACLE, POSTGRES, SQLSERVER2012, SYBASE })
     ...
     */
    @Support({ ASE, CUBRID, DB2, DERBY, H2, HSQLDB, INGRES, MARIADB, MYSQL, ORACLE, POSTGRES, SQLSERVER, SYBASE })
...
// [jooq-tools] END [row-field]
     ...
     */
    @Support({ ACCESS, ASE, CUBRID, DB2, FIREBIRD, H2, HANA, HSQLDB, INFORMIX, INGRES, MARIADB, MYSQL, ORACLE, POSTGRES, SQLSERVER, SYBASE, SQLITE })
     ...
     */
    @Support({ CUBRID, DB2, H2, HSQLDB, INFORMIX, ORACLE, POSTGRES })
     ...
     */
    @Support({ ACCESS, ASE, CUBRID, DB2, DERBY, FIREBIRD, H2, HANA, HSQLDB, INGRES, MARIADB, MYSQL, ORACLE, POSTGRES, REDSHIFT, SQLITE, SQLSERVER, SYBASE })
     ...
     */
    @Support({ CUBRID, HSQLDB, ORACLE, POSTGRES_9_4, SYBASE })
     ...
     */
    @Support({ ORACLE, POSTGRES_9_4, SQLSERVER2012, REDSHIFT })
