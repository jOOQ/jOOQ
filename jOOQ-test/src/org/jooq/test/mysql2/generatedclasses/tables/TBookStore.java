...
public class TBookStore extends org.jooq.impl.UpdatableTableImpl<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord> {
	...
	private static final long serialVersionUID = 1378383703;
	 ...
	 * The book store ID
	 */
	public final org.jooq.TableField<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord, java.lang.Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER, this);
	...
	@Override
	public org.jooq.Identity<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord, java.lang.Integer> getIdentity() {
		return org.jooq.test.mysql2.generatedclasses.Keys.IDENTITY_t_book_store;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord>>asList(org.jooq.test.mysql2.generatedclasses.Keys.KEY_t_book_store_uk_t_book_store_name, org.jooq.test.mysql2.generatedclasses.Keys.KEY_t_book_store_uk_t_book_store_id);
	}
