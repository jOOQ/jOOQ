 ...
 * This class is generated by jOOQ.
 */
class PkgPAuthorExists1 extends AbstractRoutine[java.lang.Void]("PKG_P_AUTHOR_EXISTS", Test.TEST, Library.LIBRARY) {
	{
		addInParameter(PkgPAuthorExists1.AUTHOR_NAME)
		addOutParameter(PkgPAuthorExists1.RESULT)
		setOverloaded(true)
	}
	...
	def setAuthorName(value : String) : Unit = {
		setValue(PkgPAuthorExists1.AUTHOR_NAME, value)
	}
	...
	def getResult : BigDecimal = {
		getValue(PkgPAuthorExists1.RESULT)
	}
}
