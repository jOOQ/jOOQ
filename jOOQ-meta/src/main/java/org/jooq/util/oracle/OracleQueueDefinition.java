 ...
 * @author Lukas Eder
 */
public class OracleQueueDefinition extends AbstractDefinition {

    private final UDTDefinition udt;

    public OracleQueueDefinition(SchemaDefinition schema, String name, String comment, UDTDefinition udt) {
