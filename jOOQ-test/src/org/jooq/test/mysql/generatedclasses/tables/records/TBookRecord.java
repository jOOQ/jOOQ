...
public class TBookRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.mysql.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = 1393344354;
	...
	/**
	 * Link this record to a given {@link org.jooq.test.mysql.generatedclasses.tables.records.TLanguageRecord 
	 * TLanguageRecord}
	 */
	public void setLanguageId(org.jooq.test.mysql.generatedclasses.tables.records.TLanguageRecord value) {
		if (value == null) {
			setValue(org.jooq.test.mysql.generatedclasses.tables.TBook.LANGUAGE_ID, null);
		}
		else {
			setValue(org.jooq.test.mysql.generatedclasses.tables.TBook.LANGUAGE_ID, value.getValue(org.jooq.test.mysql.generatedclasses.tables.TLanguage.ID));
		}
	}
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.mysql.generatedclasses.tables.records.TLanguageRecord fetchTLanguage() {
		return create()
			.selectFrom(org.jooq.test.mysql.generatedclasses.tables.TLanguage.T_LANGUAGE)
			.where(org.jooq.test.mysql.generatedclasses.tables.TLanguage.ID.equal(getValue(org.jooq.test.mysql.generatedclasses.tables.TBook.LANGUAGE_ID)))
			.fetchOne();
	}
