...
public class T_725LobTestRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ase.generatedclasses.tables.records.T_725LobTestRecord> implements org.jooq.Record2<java.lang.Integer, byte[]> {

	private static final long serialVersionUID = -2022891265;
	...
	public org.jooq.Field<java.lang.Integer> field1() {
		return org.jooq.test.ase.generatedclasses.tables.T_725LobTest.ID;
	}
	...
	public org.jooq.Field<byte[]> field2() {
		return org.jooq.test.ase.generatedclasses.tables.T_725LobTest.LOB;
	}
    ...
    @Override
    public Record2<Integer, byte[]> value1(Integer value) {
        return null;
    }

    @Override
    public Record2<Integer, byte[]> value2(byte[] value) {
        return null;
    }

    @Override
    public Record2<Integer, byte[]> values(Integer t1, byte[] t2) {
        return null;
    }
}
