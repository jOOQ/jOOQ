...
public class TBookToBookStoreRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.derby.generatedclasses.tables.records.TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = 760650471;
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.derby.generatedclasses.tables.records.TBookStoreRecord fetchTBookStore() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.derby.generatedclasses.tables.records.TBookStoreRecord getTBookStore() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.derby.generatedclasses.tables.TBookStore.T_BOOK_STORE)
			.where(org.jooq.test.derby.generatedclasses.tables.TBookStore.NAME.equal(getValue(org.jooq.test.derby.generatedclasses.tables.TBookToBookStore.BOOK_STORE_NAME)))
			.fetchOne();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.derby.generatedclasses.tables.records.TBookRecord fetchTBook() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.derby.generatedclasses.tables.records.TBookRecord getTBook() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.derby.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.derby.generatedclasses.tables.TBook.ID.equal(getValue(org.jooq.test.derby.generatedclasses.tables.TBookToBookStore.BOOK_ID)))
			.fetchOne();
	...
	public TBookToBookStoreRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.derby.generatedclasses.tables.TBookToBookStore.T_BOOK_TO_BOOK_STORE, configuration);
	}
}
