...
public class DbAttribute extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	public DbAttribute(java.lang.String alias) {
		this(alias, org.jooq.util.cubrid.dba.tables.DbAttribute.DB_ATTRIBUTE);
	}
	...
	public org.jooq.util.cubrid.dba.tables.DbAttribute as(java.lang.String alias) {
		return new org.jooq.util.cubrid.dba.tables.DbAttribute(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.cubrid.dba.tables.DbAttribute rename(java.lang.String name) {
		return new org.jooq.util.cubrid.dba.tables.DbAttribute(name, null);
	}
}
