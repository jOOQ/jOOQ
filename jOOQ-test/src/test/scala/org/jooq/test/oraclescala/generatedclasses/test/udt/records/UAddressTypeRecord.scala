 ...
 * This class is generated by jOOQ.
 */
class UAddressTypeRecord extends UDTRecordImpl[UAddressTypeRecord](UAddressType.U_ADDRESS_TYPE) with Record8[UStreetTypeRecord, String, String, String, Date, Integer, Array[scala.Byte], String] {
	...
	override def fieldsRow : Row8[UStreetTypeRecord, String, String, String, Date, Integer, Array[scala.Byte], String] = {
		super.fieldsRow.asInstanceOf[ Row8[UStreetTypeRecord, String, String, String, Date, Integer, Array[scala.Byte], String] ]
	}

	override def valuesRow : Row8[UStreetTypeRecord, String, String, String, Date, Integer, Array[scala.Byte], String] = {
		super.valuesRow.asInstanceOf[ Row8[UStreetTypeRecord, String, String, String, Date, Integer, Array[scala.Byte], String] ]
	}
	...
	override def field7 : Field[Array[scala.Byte]] = UAddressType.F_1323
	...
	override def value7 : Array[scala.Byte] = getF_1323
	...
	override def value7(value : Array[scala.Byte]) : UAddressTypeRecord = {
		setF_1323(value)
		this
	}
	 ...
	 */
	def this(street : UStreetTypeRecord, zip : String, city : String, country : String, since : Date, code : Integer, f_1323 : Array[scala.Byte], f_1326 : String) = {
		this()
