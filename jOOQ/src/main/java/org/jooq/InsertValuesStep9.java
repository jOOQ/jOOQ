...
public interface InsertValuesStep9<R extends Record, T1, T2, T3, T4, T5, T6, T7, T8, T9> extends InsertOnDuplicateStep<R> {
    ...
    @NotNull @CheckReturnValue
    @Support
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> values(Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> values);
    ...
    @NotNull @CheckReturnValue
    @Support
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> values(Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9> values);
    ...
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRows(Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>... values);
    ...
    @NotNull @CheckReturnValue
    @Support
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRows(Collection<? extends Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> values);
    ...
    @Support
    @SuppressWarnings("unchecked")
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRecords(Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>... values);
    ...
    @NotNull @CheckReturnValue
    @Support
    InsertValuesStep9<R, T1, T2, T3, T4, T5, T6, T7, T8, T9> valuesOfRecords(Collection<? extends Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> values);
