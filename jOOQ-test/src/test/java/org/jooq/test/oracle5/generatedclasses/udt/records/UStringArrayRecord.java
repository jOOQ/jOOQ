...
public class UStringArrayRecord extends org.jooq.impl.ArrayRecordImpl<java.lang.String> {
	...
	private static final long serialVersionUID = 148737102;
	...
	public UStringArrayRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.oracle5.generatedclasses.Test.TEST, "U_STRING_ARRAY", org.jooq.impl.SQLDataType.VARCHAR.length(20), configuration);
	}
	...
	public UStringArrayRecord() {
		super(org.jooq.test.oracle5.generatedclasses.Test.TEST, "U_STRING_ARRAY", org.jooq.impl.SQLDataType.VARCHAR.length(20));
	}
