...
public class TDatesRecord extends UpdatableRecordImpl<TDatesRecord> implements Record6<Integer, Date, Timestamp, Timestamp, Integer, Long>, ITDates {

	private static final long serialVersionUID = -355570243;
	 ...
	 */
	public TDatesRecord setT(Timestamp value) {
		setValue(2, value);
		return this;
	}
	 ...
	 */
	@Override
	public Row6<Integer, Date, Timestamp, Timestamp, Integer, Long> fieldsRow() {
	 ...
	 */
	@Override
	public Row6<Integer, Date, Timestamp, Timestamp, Integer, Long> valuesRow() {
	 ...
	 */
	@Override
	public TDatesRecord values(Integer value1, Date value2, Timestamp value3, Timestamp value4, Integer value5, Long value6) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TDatesRecord(Integer id, Date d, Timestamp t, Timestamp ts, Integer dInt, Long tsBigint) {
		super(TDates.T_DATES);
