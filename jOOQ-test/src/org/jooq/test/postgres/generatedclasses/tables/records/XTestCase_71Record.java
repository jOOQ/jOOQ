...
public class XTestCase_71Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.postgres.generatedclasses.tables.records.XTestCase_71Record> {
	...
	private static final long serialVersionUID = 769754399;
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.postgres.generatedclasses.tables.records.XTestCase_64_69Record fetchXTestCase_64_69() throws java.sql.SQLException {
		return create()
	...
	public XTestCase_71Record(org.jooq.Configuration configuration) {
		super(org.jooq.test.postgres.generatedclasses.tables.XTestCase_71.X_TEST_CASE_71, configuration);
	}
}
