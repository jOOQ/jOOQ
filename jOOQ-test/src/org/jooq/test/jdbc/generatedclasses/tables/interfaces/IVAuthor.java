...
public interface IVAuthor extends java.io.Serializable {
	 ...
	 */
	public void from(org.jooq.test.jdbc.generatedclasses.tables.interfaces.IVAuthor from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface IVAuthor
	 */
	public <E extends org.jooq.test.jdbc.generatedclasses.tables.interfaces.IVAuthor> E into(E into);
}
