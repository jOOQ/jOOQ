...
public class XUnusedRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.mysql.generatedclasses.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = 203329804;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.mysql.generatedclasses.tables.records.XTestCase_85Record> fetchXTestCase_85List() throws java.sql.SQLException {
		return create()
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.mysql.generatedclasses.tables.records.XUnusedRecord> fetchXUnusedList() throws java.sql.SQLException {
		return create()
	...
	public XUnusedRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.mysql.generatedclasses.tables.XUnused.X_UNUSED, configuration);
	}
}
