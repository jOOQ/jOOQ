...
public class TBookRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.mysql.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = -143961945;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.mysql.generatedclasses.tables.records.TBookToBookStoreRecord> fetchTBookToBookStoreList() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.mysql.generatedclasses.tables.records.TBookToBookStoreRecord> getTBookToBookStoreList() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.mysql.generatedclasses.tables.TBookToBookStore.T_BOOK_TO_BOOK_STORE)
			.where(org.jooq.test.mysql.generatedclasses.tables.TBookToBookStore.BOOK_ID.equal(getValue(org.jooq.test.mysql.generatedclasses.tables.TBook.ID)))
			.fetch();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.mysql.generatedclasses.tables.records.TAuthorRecord fetchTAuthorByAuthorId() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.mysql.generatedclasses.tables.records.TAuthorRecord getTAuthorByAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.mysql.generatedclasses.tables.TAuthor.T_AUTHOR)
			.where(org.jooq.test.mysql.generatedclasses.tables.TAuthor.ID.equal(getValue(org.jooq.test.mysql.generatedclasses.tables.TBook.AUTHOR_ID)))
			.fetchOne();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.mysql.generatedclasses.tables.records.TAuthorRecord fetchTAuthorByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.mysql.generatedclasses.tables.TAuthor.T_AUTHOR)
	 ...
	 */
	@Deprecated
	public org.jooq.test.mysql.generatedclasses.tables.records.TAuthorRecord getTAuthorByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.mysql.generatedclasses.tables.TAuthor.T_AUTHOR)
			.where(org.jooq.test.mysql.generatedclasses.tables.TAuthor.ID.equal(getValue(org.jooq.test.mysql.generatedclasses.tables.TBook.CO_AUTHOR_ID)))
			.fetchOne();
	...
	public TBookRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.mysql.generatedclasses.tables.TBook.T_BOOK, configuration);
	}
}
