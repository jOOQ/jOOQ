...
public class TBookStore extends org.jooq.impl.TableImpl<org.jooq.test.informix.generatedclasses.tables.records.TBookStoreRecord> {
	 ...
	 */
	public static final org.jooq.test.informix.generatedclasses.tables.TBookStore T_BOOK_STORE = new org.jooq.test.informix.generatedclasses.tables.TBookStore();

	/**
	 * The class holding records for this type
	 */
	@Override
	public java.lang.Class<org.jooq.test.informix.generatedclasses.tables.records.TBookStoreRecord> getRecordType() {
		return org.jooq.test.informix.generatedclasses.tables.records.TBookStoreRecord.class;
	}
	...
	/**
	 * Create an aliased <code>informix.t_book_store</code> table reference
	 */
	public TBookStore(java.lang.String alias) {
		this(alias, org.jooq.test.informix.generatedclasses.tables.TBookStore.T_BOOK_STORE);
	}

	private TBookStore(java.lang.String alias, org.jooq.Table<org.jooq.test.informix.generatedclasses.tables.records.TBookStoreRecord> aliased) {
	 ...
	 */
	@Override
	public org.jooq.test.informix.generatedclasses.tables.TBookStore as(java.lang.String alias) {
		return new org.jooq.test.informix.generatedclasses.tables.TBookStore(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.test.informix.generatedclasses.tables.TBookStore rename(java.lang.String name) {
		return new org.jooq.test.informix.generatedclasses.tables.TBookStore(name, null);
	}
}
