...
public class Display extends org.jooq.impl.AbstractRoutine<org.jooq.examples.oracle.sys.udt.records.DbmsXplanTypeTableRecord> {
	...
	private static final long serialVersionUID = -1087434799;
	 ...
	 */
	public static final org.jooq.Parameter<java.lang.String> TABLE_NAME = createParameter("TABLE_NAME", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);

	/**
	 * The parameter <code>SYS.DBMS_XPLAN.DISPLAY.STATEMENT_ID</code>. 
	 */
	public static final org.jooq.Parameter<java.lang.String> STATEMENT_ID = createParameter("STATEMENT_ID", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);

	/**
	 * The parameter <code>SYS.DBMS_XPLAN.DISPLAY.FORMAT</code>. 
	 */
	public static final org.jooq.Parameter<java.lang.String> FORMAT = createParameter("FORMAT", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);

	/**
	 * The parameter <code>SYS.DBMS_XPLAN.DISPLAY.FILTER_PREDS</code>. 
	 */
	public static final org.jooq.Parameter<java.lang.String> FILTER_PREDS = createParameter("FILTER_PREDS", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);
