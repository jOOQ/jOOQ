...
public class SdoTriangulate extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = 1342776288;

	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_TRIANGULATE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_TRIANGULATE.GEOM</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_TRIANGULATE.TOL</code>.
	 */
	 ...
	 */
	public SdoTriangulate() {
		super("SDO_TRIANGULATE", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.packages.SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
	...
	public void setGeom(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoTriangulate.GEOM, value);
	}
	...
	public void setTol(java.lang.Number value) {
		setNumber(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoTriangulate.TOL, value);
	}
