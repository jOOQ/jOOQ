...
public class CurrencyRate extends org.jooq.impl.TableImpl<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate> {

	private static final long serialVersionUID = -119542687;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.lang.Integer> CurrencyRateID = createField("CurrencyRateID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.CurrencyRateDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.sql.Timestamp> CurrencyRateDate = createField("CurrencyRateDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.FromCurrencyCode</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.lang.String> FromCurrencyCode = createField("FromCurrencyCode", org.jooq.impl.SQLDataType.NCHAR.length(3).nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.ToCurrencyCode</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.lang.String> ToCurrencyCode = createField("ToCurrencyCode", org.jooq.impl.SQLDataType.NCHAR.length(3).nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.AverageRate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.math.BigDecimal> AverageRate = createField("AverageRate", org.jooq.impl.SQLDataType.NUMERIC.precision(19, 4).nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.EndOfDayRate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.math.BigDecimal> EndOfDayRate = createField("EndOfDayRate", org.jooq.impl.SQLDataType.NUMERIC.precision(19, 4).nullable(false), this);

	/**
	 * The column <code>Sales.CurrencyRate.ModifiedDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.CurrencyRate, java.sql.Timestamp> ModifiedDate = createField("ModifiedDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this);
