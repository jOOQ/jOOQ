...
object F2155 {
	 ...
	 */
	val RETURN_VALUE : Parameter[LocalDateTime] = AbstractRoutine.createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.DATE, false, new LocalDateTimeConverter)
	 ...
	 */
	val P2 : Parameter[LocalDateTime] = AbstractRoutine.createParameter("P2", org.jooq.impl.SQLDataType.DATE, false, new LocalDateTimeConverter)
	 ...
	 */
	val P4 : Parameter[LocalDateTime] = AbstractRoutine.createParameter("P4", org.jooq.impl.SQLDataType.DATE, false, new LocalDateTimeConverter)
}

/**
 * This class is generated by jOOQ.
 */
class F2155 extends AbstractRoutine[LocalDateTime]("F2155", Test.TEST, org.jooq.impl.SQLDataType.DATE, new LocalDateTimeConverter()) {
	{
	 ...
	 */
	def setP2(value : LocalDateTime) : Unit = {
	 ...
	 */
	def setP2(field : Field[LocalDateTime]) : Unit = {
	 ...
	 */
	def setP4(value : LocalDateTime) : Unit = {
	 ...
	 */
	def setP4(field : Field[LocalDateTime]) : Unit = {
