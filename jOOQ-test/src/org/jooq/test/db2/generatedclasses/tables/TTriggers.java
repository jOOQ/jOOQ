...
public class TTriggers extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.TTriggersRecord> {

	private static final long serialVersionUID = 872107834;

	/**
	 * The singleton instance of <code>LIBRARY.T_TRIGGERS</code>
	 */
	...
	/**
	 * The column <code>LIBRARY.T_TRIGGERS.ID_GENERATED</code>. 
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.TTriggersRecord, java.lang.Integer> ID_GENERATED = createField("ID_GENERATED", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_TRIGGERS);

	/**
	 * The column <code>LIBRARY.T_TRIGGERS.ID</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_TRIGGERS.COUNTER</code>. 
	 */
	 ...
	 */
	private TTriggers() {
		super("T_TRIGGERS", org.jooq.test.db2.generatedclasses.Library.LIBRARY);
	}
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TTriggersRecord> getPrimaryKey() {
