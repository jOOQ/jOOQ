...
public class Appendchildxml extends AbstractRoutine<XmltypeRecord> {

	private static final long serialVersionUID = -362812537;

	/**
	 * The parameter <code>SYS.XMLTYPE.APPENDCHILDXML.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.APPENDCHILDXML.SELF</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.APPENDCHILDXML.XPATH</code>.
	 */
	public static final Parameter<String> XPATH = createParameter("XPATH", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>SYS.XMLTYPE.APPENDCHILDXML.VALUE_EXPR</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.APPENDCHILDXML.NAMESPACE</code>.
	 */
	 ...
	 */
	public Appendchildxml() {
		super("APPENDCHILDXML", Sys.SYS, Xmltype.XMLTYPE, org.jooq.test.oracle.generatedclasses.sys.udt.Xmltype.XMLTYPE.getDataType());
