...
public class TBookToBookStore extends org.jooq.impl.UpdatableTableImpl<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = 1302467219;
	 ...
	 */
	private static final java.lang.Class<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord> __RECORD_TYPE = org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord.class;
	...
	public org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord> getMainKey() {
		return org.jooq.test.db2.generatedclasses.Keys.PK_B2BS;
	}
	...
	public java.util.List<org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord>>asList(org.jooq.test.db2.generatedclasses.Keys.PK_B2BS);
	}
	...
	public java.util.List<org.jooq.ForeignKey<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.test.db2.generatedclasses.tables.records.TBookToBookStoreRecord, ?>>asList(org.jooq.test.db2.generatedclasses.Keys.FK_B2BS_BS_NAME, org.jooq.test.db2.generatedclasses.Keys.FK_B2BS_B_ID);
	}
}
