...
final class RecordImpl14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> extends AbstractRecord implements InternalRecord, Record14<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> {
    ...
    @Override
    public final RowImpl14 valuesRow() {
    ...
    @Override
    public final Record14 values(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10, T11 t11, T12 t12, T13 t13, T14 t14) {
        set(0, t1);
        set(1, t2);
        set(2, t3);
        set(3, t4);
    ...
    @Override
    public <T> Record14 with(Field<T> field, T value) {
        return (Record14) super.with(field, value);
    }

    @Override
    public <T, U> Record14 with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record14) super.with(field, value, converter);
    }
