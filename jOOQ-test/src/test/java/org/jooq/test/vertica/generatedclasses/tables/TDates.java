...
public class TDates extends TableImpl<TDatesRecord> {
	...
	private static final long serialVersionUID = 869105446;
	 ...
	 */
	public final TableField<TDatesRecord, Date> D = createField("d", org.jooq.impl.SQLDataType.DATE.defaulted(true), this, "");

	/**
	 * The column <code>public.t_dates.t</code>.
	 */
	public final TableField<TDatesRecord, Time> T = createField("t", org.jooq.impl.SQLDataType.TIME.defaulted(true), this, "");

	/**
	 * The column <code>public.t_dates.ts</code>.
	 */
	public final TableField<TDatesRecord, Timestamp> TS = createField("ts", org.jooq.impl.SQLDataType.TIMESTAMP.defaulted(true), this, "");
	 ...
	 */
	public final TableField<TDatesRecord, YearToMonth> I_Y = createField("i_y", org.jooq.impl.SQLDataType.INTERVALYEARTOMONTH.defaulted(true), this, "");

	/**
	 * The column <code>public.t_dates.i_d</code>.
	 */
	public final TableField<TDatesRecord, Object> I_D = createField("i_d", org.jooq.impl.DefaultDataType.getDefaultDataType("interval"), this, "");
