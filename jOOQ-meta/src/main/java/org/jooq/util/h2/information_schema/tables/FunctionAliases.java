...
public class FunctionAliases extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 779184912;
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.ALIAS_CATALOG</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.ALIAS_SCHEMA</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.ALIAS_NAME</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.JAVA_CLASS</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.JAVA_METHOD</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.DATA_TYPE</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.TYPE_NAME</code>
	 */
	public static final org.jooq.TableField<org.jooq.Record, java.lang.String> TYPE_NAME = createField("TYPE_NAME", org.jooq.impl.SQLDataType.VARCHAR, FUNCTION_ALIASES);

	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.COLUMN_COUNT</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.RETURNS_RESULT</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.REMARKS</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.ID</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.FUNCTION_ALIASES.SOURCE</code>
	 */
