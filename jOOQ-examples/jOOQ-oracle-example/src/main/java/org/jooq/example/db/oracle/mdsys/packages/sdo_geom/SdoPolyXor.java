...
public class SdoPolyXor extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = 1507939275;

	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_XOR.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_XOR.GEOM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_XOR.DIM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_XOR.GEOM2</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_XOR.DIM2</code>.
	 */
	 ...
	 */
	public SdoPolyXor() {
		super("SDO_POLY_XOR", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.packages.SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyXor.GEOM1, value);
	}
	...
	public void setDim1(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyXor.DIM1, value);
	}
	...
	public void setGeom2(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyXor.GEOM2, value);
	}
	...
	public void setDim2(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyXor.DIM2, value);
	}
