...
public class TBookToBookStore extends org.jooq.impl.TableImpl<org.jooq.test.jdbcoracle.generatedclasses.test.tables.records.TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = -1998475469;
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.jdbcoracle.generatedclasses.test.tables.records.TBookToBookStoreRecord, java.lang.String> BOOK_STORE_NAME = createField("BOOK_STORE_NAME", org.jooq.impl.SQLDataType.VARCHAR, T_BOOK_TO_BOOK_STORE);

	/**
	 * The column <code>TEST.T_BOOK_TO_BOOK_STORE.BOOK_ID</code>. 
	 */
	public static final org.jooq.TableField<org.jooq.test.jdbcoracle.generatedclasses.test.tables.records.TBookToBookStoreRecord, java.math.BigDecimal> BOOK_ID = createField("BOOK_ID", org.jooq.impl.SQLDataType.NUMERIC, T_BOOK_TO_BOOK_STORE);

	/**
	 * The column <code>TEST.T_BOOK_TO_BOOK_STORE.STOCK</code>. 
	 */
	public static final org.jooq.TableField<org.jooq.test.jdbcoracle.generatedclasses.test.tables.records.TBookToBookStoreRecord, java.math.BigDecimal> STOCK = createField("STOCK", org.jooq.impl.SQLDataType.NUMERIC, T_BOOK_TO_BOOK_STORE);
