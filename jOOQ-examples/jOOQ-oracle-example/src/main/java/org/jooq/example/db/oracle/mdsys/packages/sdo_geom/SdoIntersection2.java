...
public class SdoIntersection2 extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = 201446484;
	...
	public SdoIntersection2() {
		super("SDO_INTERSECTION", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
