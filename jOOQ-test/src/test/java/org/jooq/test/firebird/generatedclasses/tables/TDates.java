...
public class TDates extends org.jooq.impl.TableImpl<org.jooq.test.firebird.generatedclasses.tables.records.TDatesRecord> {
	...
	private static final long serialVersionUID = -1649921907;
	...
	public TDates(java.lang.String alias) {
		this(alias, org.jooq.test.firebird.generatedclasses.tables.TDates.T_DATES);
	}

	private TDates(java.lang.String alias, org.jooq.Table<org.jooq.test.firebird.generatedclasses.tables.records.TDatesRecord> aliased) {
		this(alias, aliased, null);
	}

	private TDates(java.lang.String alias, org.jooq.Table<org.jooq.test.firebird.generatedclasses.tables.records.TDatesRecord> aliased, org.jooq.Field<?>[] parameters) {
	...
	public org.jooq.test.firebird.generatedclasses.tables.TDates as(java.lang.String alias) {
		return new org.jooq.test.firebird.generatedclasses.tables.TDates(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.test.firebird.generatedclasses.tables.TDates rename(java.lang.String name) {
		return new org.jooq.test.firebird.generatedclasses.tables.TDates(name, null);
	}
}
