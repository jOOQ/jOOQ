...
public class PkgFManyParameters extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = -298982471;
	...
	public PkgFManyParameters() {
		super("PKG_F_MANY_PARAMETERS", Test.TEST, Library.LIBRARY, org.jooq.impl.SQLDataType.NUMERIC);
