...
public class TDates extends TableImpl<TDatesRecord> {
	...
	private static final long serialVersionUID = 1554670020;
	 ...
	 */
	@Override
	public java.lang.Class<TDatesRecord> getRecordType() {
	...
	private TDates(java.lang.String alias, Table<TDatesRecord> aliased) {
		this(alias, aliased, null);
	}

	private TDates(java.lang.String alias, Table<TDatesRecord> aliased, Field<?>[] parameters) {
	 ...
	 * Rename this table
	 */
	public TDates rename(java.lang.String name) {
