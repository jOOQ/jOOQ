...
public class AWBuildVersion extends org.jooq.impl.TableImpl<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion> {
	...
	private static final long serialVersionUID = 752781630;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion, org.jooq.types.UByte> SystemInformationID = createField("SystemInformationID", org.jooq.impl.SQLDataType.TINYINTUNSIGNED.nullable(false), this);

	/**
	 * The column <code>dbo.AWBuildVersion.Database Version</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion, java.lang.String> Database_Version = createField("Database Version", org.jooq.impl.SQLDataType.NVARCHAR.length(25).nullable(false), this);

	/**
	 * The column <code>dbo.AWBuildVersion.VersionDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion, java.sql.Timestamp> VersionDate = createField("VersionDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this);

	/**
	 * The column <code>dbo.AWBuildVersion.ModifiedDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion, java.sql.Timestamp> ModifiedDate = createField("ModifiedDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this);
	 ...
	 */
	@Override
	public org.jooq.Identity<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.AWBuildVersion, org.jooq.types.UByte> getIdentity() {
