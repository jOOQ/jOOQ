...
public class PDefault extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1066204953;
	 ...
	 */
	public static final org.jooq.Parameter<java.time.LocalDateTime> P_IN_DATE = createParameter("P_IN_DATE", org.jooq.impl.SQLDataType.DATE.defaulted(true), true);

	/**
	 * The parameter <code>TEST.P_DEFAULT.P_OUT_DATE</code>.
	 */
	public static final org.jooq.Parameter<java.time.LocalDateTime> P_OUT_DATE = createParameter("P_OUT_DATE", org.jooq.impl.SQLDataType.DATE);
