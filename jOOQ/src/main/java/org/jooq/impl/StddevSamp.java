    ...
    MStddevSamp
{
    ...
    @Override
    public final MStddevSamp $field(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MStddevSamp> constructor() {
        return (a1) -> new StddevSamp((Field<? extends Number>) a1);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof StddevSamp) {
            return
                StringUtils.equals($field(), ((StddevSamp) that).$field())
            ;
        }
        else
