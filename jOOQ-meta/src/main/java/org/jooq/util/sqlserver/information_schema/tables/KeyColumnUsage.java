...
public class KeyColumnUsage extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -1068470761;
	...
	public KeyColumnUsage(java.lang.String alias) {
		this(alias, org.jooq.util.sqlserver.information_schema.tables.KeyColumnUsage.KEY_COLUMN_USAGE);
	}
	...
	public org.jooq.util.sqlserver.information_schema.tables.KeyColumnUsage as(java.lang.String alias) {
		return new org.jooq.util.sqlserver.information_schema.tables.KeyColumnUsage(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.sqlserver.information_schema.tables.KeyColumnUsage rename(java.lang.String name) {
		return new org.jooq.util.sqlserver.information_schema.tables.KeyColumnUsage(name, null);
	}
}
