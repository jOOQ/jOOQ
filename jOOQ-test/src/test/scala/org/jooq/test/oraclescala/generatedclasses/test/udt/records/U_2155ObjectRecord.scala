 ...
 * This class is generated by jOOQ.
 */
class U_2155ObjectRecord extends UDTRecordImpl[U_2155ObjectRecord](U_2155Object.U_2155_OBJECT) with Record2[LocalDateTime, U_2155ArrayRecord] {

	/**
	 * Setter for <code>TEST.U_2155_OBJECT.D</code>.
	 */
	def setD(value : LocalDateTime) : Unit = {
		setValue(0, value)
	}
	...
	override def fieldsRow : Row2[LocalDateTime, U_2155ArrayRecord] = {
		super.fieldsRow.asInstanceOf[ Row2[LocalDateTime, U_2155ArrayRecord] ]
	}

	override def valuesRow : Row2[LocalDateTime, U_2155ArrayRecord] = {
		super.valuesRow.asInstanceOf[ Row2[LocalDateTime, U_2155ArrayRecord] ]
	}
	override def field1 : Field[LocalDateTime] = U_2155Object.D
	override def field2 : Field[U_2155ArrayRecord] = U_2155Object.A
	override def value1 : LocalDateTime = getD
	override def value2 : U_2155ArrayRecord = getA

	override def value1(value : LocalDateTime) : U_2155ObjectRecord = {
		setD(value)
		this
	}
	...
	override def values(value1 : LocalDateTime, value2 : U_2155ArrayRecord) : U_2155ObjectRecord = {
		this
	}
	 ...
	 */
	def this(d : LocalDateTime, a : U_2155ArrayRecord) = {
		this()
