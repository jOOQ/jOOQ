...
final class ParsingStatement implements CallableStatement {
    ...
    public final ResultSet executeQuery(String sql) throws SQLException {
        return statement.executeQuery(connection.translate(sql).sql);
    }

    @Override
    public final int executeUpdate(String sql) throws SQLException {
        return statement.executeUpdate(connection.translate(sql).sql);
    }

    @Override
    public final int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return statement.executeUpdate(connection.translate(sql).sql, autoGeneratedKeys);
    }

    @Override
    public final int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return statement.executeUpdate(connection.translate(sql).sql, columnIndexes);
    }
    ...
    public final boolean execute(String sql) throws SQLException {
        return statement.execute(connection.translate(sql).sql);
    }

    @Override
    public final boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        return statement.execute(connection.translate(sql).sql, autoGeneratedKeys);
    }

    @Override
    public final boolean execute(String sql, int[] columnIndexes) throws SQLException {
        return statement.execute(connection.translate(sql).sql, columnIndexes);
    }
    ...
    public final long executeLargeUpdate(String sql) throws SQLException {
        return statement.executeLargeUpdate(connection.translate(sql).sql);
    }

    @Override
    public final long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        return statement.executeLargeUpdate(connection.translate(sql).sql, autoGeneratedKeys);
    }

    @Override
    public final long executeLargeUpdate(String sql, int[] columnIndexes) throws SQLException {
        return statement.executeLargeUpdate(connection.translate(sql).sql, columnIndexes);
    }
    ...
    public final void addBatch(String sql) throws SQLException {
        statement.addBatch(connection.translate(sql).sql);
    }
