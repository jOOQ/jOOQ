...
public class DefaultSchema extends org.jooq.impl.SchemaImpl {
	...
	private final java.util.List<org.jooq.Table<?>> getTables0() {
		return java.util.Arrays.<org.jooq.Table<?>>asList(
			...
			org.jooq.test.firebird.generatedclasses.tables.TAuthor.T_AUTHOR,
			org.jooq.test.firebird.generatedclasses.tables.TBook.T_BOOK,
			org.jooq.test.firebird.generatedclasses.tables.TBookStore.T_BOOK_STORE,
			...
			org.jooq.test.firebird.generatedclasses.tables.TUnsigned.T_UNSIGNED,
			org.jooq.test.firebird.generatedclasses.tables.VAuthor.V_AUTHOR,
			org.jooq.test.firebird.generatedclasses.tables.VBook.V_BOOK,
			org.jooq.test.firebird.generatedclasses.tables.VLibrary.V_LIBRARY,
			org.jooq.test.firebird.generatedclasses.tables.XTestCase_2025.X_TEST_CASE_2025,
			org.jooq.test.firebird.generatedclasses.tables.XTestCase_64_69.X_TEST_CASE_64_69,
			org.jooq.test.firebird.generatedclasses.tables.XTestCase_71.X_TEST_CASE_71,
			org.jooq.test.firebird.generatedclasses.tables.XTestCase_85.X_TEST_CASE_85,
			org.jooq.test.firebird.generatedclasses.tables.XUnused.X_UNUSED);
	}
}
