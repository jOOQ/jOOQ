...
public class TableConstraints extends TableImpl<Record> {
	...
	private static final long serialVersionUID = 361027743;
	 ...
	 */
	public final TableField<Record, String> IS_DEFERRABLE = createField("is_deferrable", org.jooq.impl.SQLDataType.VARCHAR, this, "");

	/**
	 * The column <code>information_schema.table_constraints.initially_deferred</code>.
	 */
	public final TableField<Record, String> INITIALLY_DEFERRED = createField("initially_deferred", org.jooq.impl.SQLDataType.VARCHAR, this, "");
