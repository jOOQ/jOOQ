...
public class BuildPlanXml extends org.jooq.impl.AbstractRoutine<java.lang.Object> {
	...
	private static final long serialVersionUID = -1750359100;
	 ...
	 */
	public static final org.jooq.Parameter<java.math.BigDecimal> PLAN_ID = createParameter("PLAN_ID", org.jooq.impl.SQLDataType.NUMERIC.defaulted(true), true);
	 ...
	 */
	public static final org.jooq.Parameter<java.lang.String> PLAN_TAG = createParameter("PLAN_TAG", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);

	/**
	 * The parameter <code>SYS.DBMS_XPLAN.BUILD_PLAN_XML.REPORT_REF</code>. 
	 */
	public static final org.jooq.Parameter<java.lang.String> REPORT_REF = createParameter("REPORT_REF", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);
