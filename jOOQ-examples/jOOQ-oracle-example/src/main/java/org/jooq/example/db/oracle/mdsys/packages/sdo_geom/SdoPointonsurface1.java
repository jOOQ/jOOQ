...
public class SdoPointonsurface1 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = 2054355455;

	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POINTONSURFACE.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POINTONSURFACE.GEOM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POINTONSURFACE.DIM1</code>.
	 */
	 ...
	 */
	public SdoPointonsurface1() {
		super("SDO_POINTONSURFACE", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.packages.SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPointonsurface1.GEOM1, value);
	}
	...
	public void setDim1(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPointonsurface1.DIM1, value);
	}
