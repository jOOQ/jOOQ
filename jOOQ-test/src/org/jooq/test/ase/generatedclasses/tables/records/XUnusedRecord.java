...
public class XUnusedRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ase.generatedclasses.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = 1981777871;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ase.generatedclasses.tables.records.XUnusedRecord> fetchXUnusedList() {
		return create()
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ase.generatedclasses.tables.records.XTestCase_85Record> fetchXTestCase_85List() {
		return create()
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ase.generatedclasses.tables.records.XTestCase_64_69Record> fetchXTestCase_64_69List() {
		return create()
