...
public class SdoPolyIntersection extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = -1031278567;
	...
	public SdoPolyIntersection() {
		super("SDO_POLY_INTERSECTION", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
