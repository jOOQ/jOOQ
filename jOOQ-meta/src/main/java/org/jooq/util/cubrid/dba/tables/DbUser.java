...
public class DbUser extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	public DbUser(java.lang.String alias) {
		this(alias, org.jooq.util.cubrid.dba.tables.DbUser.DB_USER);
	}
	...
	public org.jooq.util.cubrid.dba.tables.DbUser as(java.lang.String alias) {
		return new org.jooq.util.cubrid.dba.tables.DbUser(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.cubrid.dba.tables.DbUser rename(java.lang.String name) {
		return new org.jooq.util.cubrid.dba.tables.DbUser(name, null);
	}
}
