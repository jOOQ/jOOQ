...
final class RecordImpl10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends AbstractRecord implements InternalRecord, Record10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
    ...
    @Override
    public final Record10 values(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9, T10 t10) {
        set(0, t1);
        set(1, t2);
        set(2, t3);
        set(3, t4);
    ...
    @Override
    public <T> Record10 with(Field<T> field, T value) {
        return (Record10) super.with(field, value);
    }

    @Override
    public <T, U> Record10 with(Field<T> field, U value, Converter<? extends T, ? super U> converter) {
        return (Record10) super.with(field, value, converter);
    }
