...
public class PArrays3 extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1063767132;

	/**
	 * The parameter <code>TEST.P_ARRAYS3.IN_ARRAY</code>.
	 */
	public static final org.jooq.Parameter<org.jooq.test.oracle5.generatedclasses.udt.records.UStringArrayRecord> IN_ARRAY = createParameter("IN_ARRAY", org.jooq.impl.SQLDataType.VARCHAR.length(20).asArrayDataType(org.jooq.test.oracle5.generatedclasses.udt.records.UStringArrayRecord.class));

	/**
	 * The parameter <code>TEST.P_ARRAYS3.OUT_ARRAY</code>.
	 */
	public static final org.jooq.Parameter<org.jooq.test.oracle5.generatedclasses.udt.records.UStringArrayRecord> OUT_ARRAY = createParameter("OUT_ARRAY", org.jooq.impl.SQLDataType.VARCHAR.length(20).asArrayDataType(org.jooq.test.oracle5.generatedclasses.udt.records.UStringArrayRecord.class));
