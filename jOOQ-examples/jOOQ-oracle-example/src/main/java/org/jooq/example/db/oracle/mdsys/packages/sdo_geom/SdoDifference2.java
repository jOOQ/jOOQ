...
public class SdoDifference2 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = -1756600473;
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_DIFFERENCE.TOL</code>.
	 */
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoDifference2.GEOM1, value);
	}
	...
	public void setGeom2(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoDifference2.GEOM2, value);
	}
	...
	public void setTol(java.lang.Number value) {
		setNumber(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoDifference2.TOL, value);
	}
