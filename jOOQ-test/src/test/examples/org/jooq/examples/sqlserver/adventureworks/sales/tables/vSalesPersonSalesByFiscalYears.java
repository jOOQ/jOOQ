...
public class vSalesPersonSalesByFiscalYears extends org.jooq.impl.TableImpl<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears> {
	...
	private static final long serialVersionUID = -810110800;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.lang.String> FullName = createField("FullName", org.jooq.impl.SQLDataType.NVARCHAR.length(152), this);

	/**
	 * The column <code>Sales.vSalesPersonSalesByFiscalYears.JobTitle</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.lang.String> JobTitle = createField("JobTitle", org.jooq.impl.SQLDataType.NVARCHAR.length(50).nullable(false), this);

	/**
	 * The column <code>Sales.vSalesPersonSalesByFiscalYears.SalesTerritory</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.lang.String> SalesTerritory = createField("SalesTerritory", org.jooq.impl.SQLDataType.NVARCHAR.length(50).nullable(false), this);

	/**
	 * The column <code>Sales.vSalesPersonSalesByFiscalYears.2002</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.math.BigDecimal> _2002 = createField("2002", org.jooq.impl.SQLDataType.NUMERIC.precision(19, 4), this);

	/**
	 * The column <code>Sales.vSalesPersonSalesByFiscalYears.2003</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.math.BigDecimal> _2003 = createField("2003", org.jooq.impl.SQLDataType.NUMERIC.precision(19, 4), this);

	/**
	 * The column <code>Sales.vSalesPersonSalesByFiscalYears.2004</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.sales.tables.records.vSalesPersonSalesByFiscalYears, java.math.BigDecimal> _2004 = createField("2004", org.jooq.impl.SQLDataType.NUMERIC.precision(19, 4), this);
