...
public class PublicObject extends AbstractRoutine<NumberObjectRecord> {
	...
	private static final long serialVersionUID = -887897027;
	 ...
	 */
	public PublicObject() {
		super("PUBLIC_OBJECT", MultiSchema.MULTI_SCHEMA, MsSynonymPackage.MS_SYNONYM_PACKAGE, org.jooq.test.oracle.generatedclasses.multi_schema.udt.NumberObject.NUMBER_OBJECT.getDataType());
