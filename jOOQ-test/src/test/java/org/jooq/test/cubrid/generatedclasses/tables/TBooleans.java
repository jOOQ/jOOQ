...
public class TBooleans extends TableImpl<TBooleansRecord> {
	...
	private static final long serialVersionUID = 1879405661;
	 ...
	 */
	public static final TableField<TBooleansRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_BOOLEANS, "");
	 ...
	 */
	public static final TableField<TBooleansRecord, Boolean_YES_NO_LC> YES_NO_LC = createField("yes_no_lc", org.jooq.impl.SQLDataType.VARCHAR, T_BOOLEANS, "", new Boolean_YES_NO_LC_Converter());

	/**
	 * The column <code>t_booleans.yes_no_uc</code>.
	 */
	public static final TableField<TBooleansRecord, Boolean_YES_NO_UC> YES_NO_UC = createField("yes_no_uc", org.jooq.impl.SQLDataType.VARCHAR, T_BOOLEANS, "", new Boolean_YES_NO_UC_Converter());
	...
	public List<UniqueKey<TBooleansRecord>> getKeys() {
		return Arrays.<UniqueKey<TBooleansRecord>>asList(Keys.T_BOOLEANS__PK_T_BOOLEANS);
	}
}
