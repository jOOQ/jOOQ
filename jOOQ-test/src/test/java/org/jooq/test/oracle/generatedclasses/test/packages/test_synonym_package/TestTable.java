...
public class TestTable extends AbstractRoutine<NumberTableRecord> {
	...
	private static final long serialVersionUID = -1447087621;
	 ...
	 */
	public TestTable() {
		super("TEST_TABLE", Test.TEST, TestSynonymPackage.TEST_SYNONYM_PACKAGE, org.jooq.impl.SQLDataType.INTEGER.asArrayDataType(org.jooq.test.oracle.generatedclasses.multi_schema.udt.records.NumberTableRecord.class));
