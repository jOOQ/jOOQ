...
public class TBook extends TableImpl<TBookRecord> {
	...
	private static final long serialVersionUID = -875165616;
	 ...
	 */
	public final TableField<TBookRecord, UBookStatus> STATUS = createField("status", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(org.jooq.test.postgres.generatedclasses.enums.UBookStatus.class), this, "The book's stock status");
	...
	public List<ForeignKey<TBookRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<TBookRecord, ?>>asList(org.jooq.test.postgres.generatedclasses.Keys.T_BOOK__FK_T_BOOK_AUTHOR_ID, org.jooq.test.postgres.generatedclasses.Keys.T_BOOK__FK_T_BOOK_CO_AUTHOR_ID, Keys.T_BOOK__FK_T_BOOK_LANGUAGE_ID);
	}
