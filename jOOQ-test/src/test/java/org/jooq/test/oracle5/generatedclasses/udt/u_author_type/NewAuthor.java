...
public class NewAuthor extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1387907940;
	 ...
	 */
	public static final org.jooq.Parameter<org.jooq.test.oracle5.generatedclasses.udt.records.UAuthorTypeRecord> P_AUTHOR = createParameter("P_AUTHOR", org.jooq.test.oracle5.generatedclasses.udt.UAuthorType.U_AUTHOR_TYPE.getDataType(), false);

	/**
	 * Create a new routine call instance
	 */
	public NewAuthor() {
		super("NEW_AUTHOR", org.jooq.test.oracle5.generatedclasses.Test.TEST, org.jooq.test.oracle5.generatedclasses.udt.UAuthorType.U_AUTHOR_TYPE);
	...
	public void setPId(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.udt.u_author_type.NewAuthor.P_ID, value);
	}
	...
	public void setPFirstName(java.lang.String value) {
		setValue(org.jooq.test.oracle5.generatedclasses.udt.u_author_type.NewAuthor.P_FIRST_NAME, value);
	}
	...
	public void setPLastName(java.lang.String value) {
		setValue(org.jooq.test.oracle5.generatedclasses.udt.u_author_type.NewAuthor.P_LAST_NAME, value);
	}

	/**
	 * Get the <code>P_AUTHOR</code> parameter OUT value from the routine
	 */
	public org.jooq.test.oracle5.generatedclasses.udt.records.UAuthorTypeRecord getPAuthor() {
