...
public class TBooleans extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.TBooleansRecord> {

	private static final long serialVersionUID = 719821349;

	/**
	 * The singleton instance of <code>LIBRARY.T_BOOLEANS</code>
	 */
	...
	public java.lang.Class<org.jooq.test.db2.generatedclasses.tables.records.TBooleansRecord> getRecordType() {
		return org.jooq.test.db2.generatedclasses.tables.records.TBooleansRecord.class;
	}

	/**
	 * The column <code>LIBRARY.T_BOOLEANS.ID</code>. 
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.TBooleansRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_BOOLEANS);

	/**
	 * The column <code>LIBRARY.T_BOOLEANS.ONE_ZERO</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.TRUE_FALSE_LC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.TRUE_FALSE_UC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.YES_NO_LC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.YES_NO_UC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.Y_N_LC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.Y_N_UC</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.VC_BOOLEAN</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.C_BOOLEAN</code>. 
	 */
	...
	/**
	 * The column <code>LIBRARY.T_BOOLEANS.N_BOOLEAN</code>. 
	 */
	 ...
	 */
	private TBooleans() {
		super("T_BOOLEANS", org.jooq.test.db2.generatedclasses.Library.LIBRARY);
	}
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TBooleansRecord> getPrimaryKey() {
