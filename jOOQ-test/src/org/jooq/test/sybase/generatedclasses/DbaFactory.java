...
public class DbaFactory extends org.jooq.util.sybase.SybaseFactory {
	...
	private static final long serialVersionUID = 1952643317;
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(org.jooq.test.sybase.generatedclasses.Dba.DBA.getName());
	}
}
