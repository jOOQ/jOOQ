...
public interface Row9<T1, T2, T3, T4, T5, T6, T7, T8, T9> extends Row, SelectField<Record9<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
     ...
     * deconstruction over the {@link Record9}'s individual component values.
     * <p>
     ...
     * some deconstruction over the {@link Record9}'s individual component
     * values.
     * <p>
     * Combine this with e.g. {@link Functions#nullOnAllNull(Function9)} or
     * {@link Functions#nullOnAnyNull(Function9)} to achieve <code>null</code>
     ...
     */
    @NotNull
    <U> SelectField<U> mapping(Class<U> uType, Function9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends U> function);
