...
public class PDefault extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 2080809756;

	/**
	 * The parameter <code>LIBRARY.P_DEFAULT.P_IN_NUMBER</code>. 
	 */
	...
	/**
	 * The parameter <code>LIBRARY.P_DEFAULT.P_OUT_NUMBER</code>. 
	 */
	...
	/**
	 * The parameter <code>LIBRARY.P_DEFAULT.P_IN_VARCHAR</code>. 
	 */
	...
	/**
	 * The parameter <code>LIBRARY.P_DEFAULT.P_OUT_VARCHAR</code>. 
	 */
	 ...
	 */
	public PDefault() {
		super("P_DEFAULT", org.jooq.test.db2.generatedclasses.Library.LIBRARY);
