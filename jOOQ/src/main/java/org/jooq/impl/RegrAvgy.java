    ...
    MRegrAvgy
{
    ...
    @Override
    public final MRegrAvgy $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MRegrAvgy $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MRegrAvgy> constructor() {
        return (a1, a2) -> new RegrAvgy((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof RegrAvgy) {
            return
                StringUtils.equals($y(), ((RegrAvgy) that).$y()) &&
                StringUtils.equals($x(), ((RegrAvgy) that).$x())
            ;
        }
        else
