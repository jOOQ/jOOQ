...
public class TypeInfo extends TableImpl<Record> {
	...
	private static final long serialVersionUID = -931469077;
	 ...
	 */
	public static final TableField<Record, String> TYPE_NAME = createField("TYPE_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), TYPE_INFO, "");
	 ...
	 */
	public static final TableField<Record, String> PREFIX = createField("PREFIX", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), TYPE_INFO, "");

	/**
	 * The column <code>INFORMATION_SCHEMA.TYPE_INFO.SUFFIX</code>.
	 */
	public static final TableField<Record, String> SUFFIX = createField("SUFFIX", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), TYPE_INFO, "");

	/**
	 * The column <code>INFORMATION_SCHEMA.TYPE_INFO.PARAMS</code>.
	 */
	public static final TableField<Record, String> PARAMS = createField("PARAMS", org.jooq.impl.SQLDataType.VARCHAR.length(2147483647), TYPE_INFO, "");
