    ...
    MCoth
{
    ...
    @Override
    public final MCoth $number(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MCoth> constructor() {
        return (a1) -> new Coth((Field<? extends Number>) a1);
    }
