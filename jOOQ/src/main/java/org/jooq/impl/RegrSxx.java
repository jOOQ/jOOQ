    ...
    MRegrSxx
{
    ...
    @Override
    public final MRegrSxx $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MRegrSxx $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MRegrSxx> constructor() {
        return (a1, a2) -> new RegrSxx((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof RegrSxx) {
            return
                StringUtils.equals($y(), ((RegrSxx) that).$y()) &&
                StringUtils.equals($x(), ((RegrSxx) that).$x())
            ;
        }
        else
