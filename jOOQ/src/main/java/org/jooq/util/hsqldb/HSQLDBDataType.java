...
public class HSQLDBDataType {
    ...
    public static final DataType<Time>        TIMEWITHOUTTIMEZONE      = new DefaultDataType<Time>(SQLDialect.HSQLDB, SQLDataType.TIME, "time without time zone");

    public static final DataType<OffsetTime>  TIMEWITHTIMEZONE         = new DefaultDataType<OffsetTime>(SQLDialect.HSQLDB, SQLDataType.TIMEWITHTIMEZONE, "time with time zone");
    ...
    public static final DataType<Timestamp>   TIMESTAMPWITHOUTTIMEZONE = new DefaultDataType<Timestamp>(SQLDialect.HSQLDB, SQLDataType.TIMESTAMP, "timestamp without time zone");
