...
public interface ConstraintForeignKeyReferencesStep8<T1, T2, T3, T4, T5, T6, T7, T8> {
    ...
    @NotNull
    @Support
    ConstraintForeignKeyOnStep references(@Stringly.Name String table, String field1, String field2, String field3, String field4, String field5, String field6, String field7, String field8);
