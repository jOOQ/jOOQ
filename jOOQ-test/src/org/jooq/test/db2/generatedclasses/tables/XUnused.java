...
public class XUnused extends org.jooq.impl.UpdatableTableImpl<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = -681849972;
	...
	/**
	 * The column <code>TEST.X_UNUSED.TABLE</code>. 
	 */
	...
	/**
	 * The column <code>TEST.X_UNUSED.VALUES</code>. 
	 */
	 ...
	 */
	private XUnused() {
		super("X_UNUSED", org.jooq.test.db2.generatedclasses.Test.TEST);
	}
