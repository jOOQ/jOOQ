...
public class XUnused extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> {

	private static final long serialVersionUID = 347818389;

	/**
	 * The singleton instance of <code>LIBRARY.X_UNUSED</code>
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.ID</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), X_UNUSED, "");

	/**
	 * The column <code>LIBRARY.X_UNUSED.NAME</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord, java.lang.String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(10).nullable(false), X_UNUSED, "");

	/**
	 * The column <code>LIBRARY.X_UNUSED.BIG_INTEGER</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.ID_REF</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.CLASS</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.FIELDS</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.TABLE</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.CONFIGURATION</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.U_D_T</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.META_DATA</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.VALUES</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.TYPE0</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.PRIMARY_KEY</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.PRIMARYKEY</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.NAME_REF</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.X_UNUSED.FIELD 737</code>.
	 */
	...
	private XUnused(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> aliased) {
		this(alias, aliased, null);
	}

	private XUnused(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.XUnusedRecord> aliased, org.jooq.Field<?>[] parameters) {
