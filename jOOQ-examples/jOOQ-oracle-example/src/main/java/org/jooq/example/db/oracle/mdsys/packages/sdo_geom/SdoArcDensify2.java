...
public class SdoArcDensify2 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = 1625275286;
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_ARC_DENSIFY.TOL</code>.
	 */
	...
	public void setGeom(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoArcDensify2.GEOM, value);
	}
	...
	public void setTol(java.lang.Number value) {
		setNumber(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoArcDensify2.TOL, value);
	}
	...
	public void setParams(java.lang.String value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoArcDensify2.PARAMS, value);
	}
