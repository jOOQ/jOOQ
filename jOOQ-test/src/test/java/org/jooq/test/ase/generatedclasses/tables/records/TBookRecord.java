...
public class TBookRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ase.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = 200998395;
	...
	/**
	 * Link this record to a given {@link org.jooq.test.ase.generatedclasses.tables.records.TAuthorRecord 
	 * TAuthorRecord}
	 */
	public void setAuthorId(org.jooq.test.ase.generatedclasses.tables.records.TAuthorRecord value) {
		if (value == null) {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.AUTHOR_ID, null);
		}
		else {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.AUTHOR_ID, value.getValue(org.jooq.test.ase.generatedclasses.tables.TAuthor.ID));
		}
	}
	 ...
	 * TAuthorRecord}
	 */
	public void setCoAuthorId(org.jooq.test.ase.generatedclasses.tables.records.TAuthorRecord value) {
		if (value == null) {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.CO_AUTHOR_ID, null);
		}
		else {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.CO_AUTHOR_ID, value.getValue(org.jooq.test.ase.generatedclasses.tables.TAuthor.ID));
		}
	}
	...
	/**
	 * Link this record to a given {@link org.jooq.test.ase.generatedclasses.tables.records.TLanguageRecord 
	 * TLanguageRecord}
	 */
	public void setLanguageId(org.jooq.test.ase.generatedclasses.tables.records.TLanguageRecord value) {
		if (value == null) {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.LANGUAGE_ID, null);
		}
		else {
			setValue(org.jooq.test.ase.generatedclasses.tables.TBook.LANGUAGE_ID, value.getValue(org.jooq.test.ase.generatedclasses.tables.TLanguage.ID));
		}
	}
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.ase.generatedclasses.tables.records.TLanguageRecord fetchTLanguage() {
		return create()
			.selectFrom(org.jooq.test.ase.generatedclasses.tables.TLanguage.T_LANGUAGE)
			.where(org.jooq.test.ase.generatedclasses.tables.TLanguage.ID.equal(getValue(org.jooq.test.ase.generatedclasses.tables.TBook.LANGUAGE_ID)))
			.fetchOne();
	}
