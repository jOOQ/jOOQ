...
public class SdoPolyUnion extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = 145531635;

	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_UNION.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_UNION.GEOM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_UNION.DIM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_UNION.GEOM2</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_POLY_UNION.DIM2</code>.
	 */
	 ...
	 */
	public SdoPolyUnion() {
		super("SDO_POLY_UNION", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.packages.SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyUnion.GEOM1, value);
	}
	...
	public void setDim1(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyUnion.DIM1, value);
	}
	...
	public void setGeom2(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyUnion.GEOM2, value);
	}
	...
	public void setDim2(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoPolyUnion.DIM2, value);
	}
