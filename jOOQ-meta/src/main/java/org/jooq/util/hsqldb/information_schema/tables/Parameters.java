...
public class Parameters extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -1709355379;
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.FROM_SQL_SPECIFIC_CATALOG</code>
	 */
	public final org.jooq.TableField<org.jooq.Record, java.lang.String> FROM_SQL_SPECIFIC_CATALOG = createField("FROM_SQL_SPECIFIC_CATALOG", org.jooq.impl.SQLDataType.VARCHAR, this);

	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.FROM_SQL_SPECIFIC_SCHEMA</code>
	 */
	public final org.jooq.TableField<org.jooq.Record, java.lang.String> FROM_SQL_SPECIFIC_SCHEMA = createField("FROM_SQL_SPECIFIC_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR, this);

	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.FROM_SQL_SPECIFIC_NAME</code>
	 */
	public final org.jooq.TableField<org.jooq.Record, java.lang.String> FROM_SQL_SPECIFIC_NAME = createField("FROM_SQL_SPECIFIC_NAME", org.jooq.impl.SQLDataType.VARCHAR, this);

	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.TO_SQL_SPECIFIC_CATALOG</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.TO_SQL_SPECIFIC_SCHEMA</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.TO_SQL_SPECIFIC_NAME</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.DECLARED_DATA_TYPE</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.DECLARED_NUMERIC_PRECISION</code>
	 */
	...
	/**
	 * The table column <code>INFORMATION_SCHEMA.PARAMETERS.DECLARED_NUMERIC_SCALE</code>
	 */
