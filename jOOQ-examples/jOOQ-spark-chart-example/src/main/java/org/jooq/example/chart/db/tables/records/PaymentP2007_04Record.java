...
public class PaymentP2007_04Record extends TableRecordImpl<PaymentP2007_04Record> implements Record6<Integer, Integer, Integer, Integer, BigDecimal, LocalDateTime> {

    private static final long serialVersionUID = -568840979;
    ...
    @Override
    public PaymentP2007_04Record values(Integer value1, Integer value2, Integer value3, Integer value4, BigDecimal value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
