...
public class CheckConstraints extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -756880233;

	/**
	 * The singleton instance of <code>INFORMATION_SCHEMA.CHECK_CONSTRAINTS</code>
	 */
	public static final org.jooq.util.sqlserver.information_schema.tables.CheckConstraints CHECK_CONSTRAINTS = new org.jooq.util.sqlserver.information_schema.tables.CheckConstraints();
	...
	public CheckConstraints(java.lang.String alias) {
		this(alias, org.jooq.util.sqlserver.information_schema.tables.CheckConstraints.CHECK_CONSTRAINTS);
	}
	 ...
	 */
	@Override
	public org.jooq.util.sqlserver.information_schema.tables.CheckConstraints as(java.lang.String alias) {
		return new org.jooq.util.sqlserver.information_schema.tables.CheckConstraints(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.sqlserver.information_schema.tables.CheckConstraints rename(java.lang.String name) {
		return new org.jooq.util.sqlserver.information_schema.tables.CheckConstraints(name, null);
	}
}
