...
public class MockStatement extends JDBC41Statement implements CallableStatement {
    ...
    private boolean execute0(
        ...
        context = new MockExecuteContext(
            new String[] { localSql },
    ...
    public long executeLargeUpdate() throws SQLException {
        return executeLargeUpdate(sql.get(0));
    }
    ...
    @Override
    public long executeLargeUpdate(String localSql) throws SQLException {
        execute0(localSql, resultSetType, resultSetConcurrency, resultSetHoldability, autoGeneratedKeys, columnIndexes, columnNames);
    ...
    @Override
    public long executeLargeUpdate(String localSql, int localAutoGeneratedKeys) throws SQLException {
        execute0(localSql, resultSetType, resultSetConcurrency, resultSetHoldability, localAutoGeneratedKeys, null, null);
        return getLargeUpdateCount();
    }
    ...
    @Override
    public long executeLargeUpdate(String localSql, int[] localColumnIndexes) throws SQLException {
        execute0(localSql, resultSetType, resultSetConcurrency, resultSetHoldability, Statement.RETURN_GENERATED_KEYS, localColumnIndexes, null);
        return getLargeUpdateCount();
    }
    ...
    @Override
    public long executeLargeUpdate(String localSql, String[] localColumnNames) throws SQLException {
        execute0(localSql, resultSetType, resultSetConcurrency, resultSetHoldability, Statement.RETURN_GENERATED_KEYS, null, localColumnNames);
        return getLargeUpdateCount();
    }
    ...
    public long[] executeLargeBatch() throws SQLException {
        ...
        long[] rows = new long[result.length];
        for (int i = 0; i < result.length; i++)
            rows[i] = result[i].largeRows;

        return rows;
    }

    private void executeBatch0() throws SQLException {
        checkNotClosed();
    ...
    public int getMaxRows() throws SQLException {
        checkNotClosed();
        return truncateUpdateCount(maxRows);
    }
