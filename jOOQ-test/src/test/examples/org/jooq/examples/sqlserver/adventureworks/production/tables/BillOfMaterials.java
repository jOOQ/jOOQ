...
public class BillOfMaterials extends org.jooq.impl.TableImpl<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials> {

	private static final long serialVersionUID = 518567221;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.lang.Integer> BillOfMaterialsID = createField("BillOfMaterialsID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this);
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.lang.Integer> ComponentID = createField("ComponentID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this);

	/**
	 * The column <code>Production.BillOfMaterials.StartDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.sql.Timestamp> StartDate = createField("StartDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this);
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.lang.String> UnitMeasureCode = createField("UnitMeasureCode", org.jooq.impl.SQLDataType.NCHAR.length(3).nullable(false), this);

	/**
	 * The column <code>Production.BillOfMaterials.BOMLevel</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.lang.Short> BOMLevel = createField("BOMLevel", org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this);

	/**
	 * The column <code>Production.BillOfMaterials.PerAssemblyQty</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.math.BigDecimal> PerAssemblyQty = createField("PerAssemblyQty", org.jooq.impl.SQLDataType.NUMERIC.precision(8, 2).nullable(false).defaulted(true), this);

	/**
	 * The column <code>Production.BillOfMaterials.ModifiedDate</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.production.tables.records.BillOfMaterials, java.sql.Timestamp> ModifiedDate = createField("ModifiedDate", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this);
