...
public class PArrays4 extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 1879052316;
	 ...
	 */
	public PArrays4() {
		super("P_ARRAYS4", org.jooq.test.oracle5.generatedclasses.Test.TEST);
	...
	public void setInArray(org.jooq.test.oracle5.generatedclasses.udt.records.UBookArrayRecord value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.PArrays4.IN_ARRAY, value);
	}

	/**
	 * Get the <code>OUT_ARRAY</code> parameter OUT value from the routine
	 */
	public org.jooq.test.oracle5.generatedclasses.udt.records.UBookArrayRecord getOutArray() {
