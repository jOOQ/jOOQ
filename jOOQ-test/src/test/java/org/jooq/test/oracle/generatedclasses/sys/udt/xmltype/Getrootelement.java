...
public class Getrootelement extends AbstractRoutine<String> {

	private static final long serialVersionUID = 206274370;

	/**
	 * The parameter <code>SYS.XMLTYPE.GETROOTELEMENT.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>SYS.XMLTYPE.GETROOTELEMENT.SELF</code>.
	 */
	...
	public Getrootelement() {
		super("GETROOTELEMENT", Sys.SYS, Xmltype.XMLTYPE, org.jooq.impl.SQLDataType.VARCHAR);
