...
public class TBookStore extends TableImpl<TBookStoreRecord> {
	...
	private static final long serialVersionUID = -1993555818;
	 ...
	 */
	public final TableField<TBookStoreRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(400).nullable(false).defaulted(true), this, "");
