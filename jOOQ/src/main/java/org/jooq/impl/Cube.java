...
final class Cube extends AbstractField<Object> implements QOM.Cube {
    ...
    public final void accept(Context<?> ctx) {
        ctx.visit(K_CUBE).sql(" (").visit(GroupingSets.wrappedList(arguments)).sql(')');
    }
    ...
    @Override
    public final Function1<? super UnmodifiableList<? extends FieldOrRow>, ? extends QOM.Cube> $constructor() {
