 ...
 * This class is generated by jOOQ.
 */
class TBookSale(alias : String, aliased : Table[TBookSaleRecord], parameters : Array[ Field[_] ]) extends TableImpl[TBookSaleRecord](alias, MultiSchema.MULTI_SCHEMA, aliased, parameters, "") {
	...
	def this(alias : String) = {
		this(alias, TBookSale.T_BOOK_SALE, null)
	}
