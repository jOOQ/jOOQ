...
public class IiindexColumns extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	/**
	 * The singleton instance of <code>$ingres.iiindex_columns</code>
	 */
	...
	/**
	 * The column <code>$ingres.iiindex_columns.index_name</code>. 
	 */
	...
	/**
	 * The column <code>$ingres.iiindex_columns.index_owner</code>. 
	 */
	...
	/**
	 * The column <code>$ingres.iiindex_columns.column_name</code>. 
	 */
	...
	/**
	 * The column <code>$ingres.iiindex_columns.key_sequence</code>. 
	 */
	...
	/**
	 * The column <code>$ingres.iiindex_columns.sort_direction</code>. 
	 */
