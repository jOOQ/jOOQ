...
public class TBooleans extends org.jooq.impl.TableImpl<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord> {
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_10> ONE_ZERO = createField("ONE_ZERO", org.jooq.impl.SQLDataType.INTEGER, T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_10_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.TRUE_FALSE_LC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_TF_LC> TRUE_FALSE_LC = createField("TRUE_FALSE_LC", org.jooq.impl.SQLDataType.VARCHAR.length(5), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_TF_LC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.TRUE_FALSE_UC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_TF_UC> TRUE_FALSE_UC = createField("TRUE_FALSE_UC", org.jooq.impl.SQLDataType.VARCHAR.length(5), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_TF_UC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.YES_NO_LC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YES_NO_LC> YES_NO_LC = createField("YES_NO_LC", org.jooq.impl.SQLDataType.VARCHAR.length(3), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_YES_NO_LC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.YES_NO_UC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YES_NO_UC> YES_NO_UC = createField("YES_NO_UC", org.jooq.impl.SQLDataType.VARCHAR.length(3), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_YES_NO_UC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.Y_N_LC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YN_LC> Y_N_LC = createField("Y_N_LC", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_YN_LC_Converter());

	/**
	 * The column <code>TEST.T_BOOLEANS.Y_N_UC</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.derby.generatedclasses.tables.records.TBooleansRecord, org.jooq.test._.converters.Boolean_YN_UC> Y_N_UC = createField("Y_N_UC", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test._.converters.Boolean_YN_UC_Converter());
