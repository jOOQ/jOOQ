...
public class TestObject extends AbstractRoutine<NumberObjectRecord> {
	...
	private static final long serialVersionUID = -1564965570;
	 ...
	 */
	public TestObject() {
		super("TEST_OBJECT", Test.TEST, TestSynonymPackage.TEST_SYNONYM_PACKAGE, org.jooq.test.oracle.generatedclasses.multi_schema.udt.NumberObject.NUMBER_OBJECT.getDataType());
