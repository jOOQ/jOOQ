 ...
 */
public interface InsertOnConflictWhereIndexStep<R extends Record> extends InsertReturningStep<R> {
     ...
     */
    @Support({ POSTGRES_9_5 })
    InsertOnConflictDoUpdateStep<R> whereNotExists(Select<?> select);
}
