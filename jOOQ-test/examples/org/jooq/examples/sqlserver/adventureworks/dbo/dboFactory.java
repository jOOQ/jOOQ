...
public class dboFactory extends org.jooq.util.sqlserver.SQLServerFactory {
	...
	private static final long serialVersionUID = 2112520172;
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(org.jooq.examples.sqlserver.adventureworks.dbo.dbo.dbo.getName());
	}
}
