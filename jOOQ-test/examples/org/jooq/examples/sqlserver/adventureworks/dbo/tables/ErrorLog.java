...
public class ErrorLog extends org.jooq.impl.TableImpl<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog> {

	private static final long serialVersionUID = -564142478;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.lang.Integer> ErrorLogID = createField("ErrorLogID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this);

	/**
	 * The column <code>dbo.ErrorLog.ErrorTime</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.sql.Timestamp> ErrorTime = createField("ErrorTime", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this);

	/**
	 * The column <code>dbo.ErrorLog.UserName</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.lang.String> UserName = createField("UserName", org.jooq.impl.SQLDataType.NVARCHAR.length(128).nullable(false), this);

	/**
	 * The column <code>dbo.ErrorLog.ErrorNumber</code>. 
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.lang.Integer> ErrorNumber = createField("ErrorNumber", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this);
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.lang.String> ErrorProcedure = createField("ErrorProcedure", org.jooq.impl.SQLDataType.NVARCHAR.length(126), this);
	 ...
	 */
	public final org.jooq.TableField<org.jooq.examples.sqlserver.adventureworks.dbo.tables.records.ErrorLog, java.lang.String> ErrorMessage = createField("ErrorMessage", org.jooq.impl.SQLDataType.NVARCHAR.length(4000).nullable(false), this);
