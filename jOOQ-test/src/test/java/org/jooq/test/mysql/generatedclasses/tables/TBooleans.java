...
public class TBooleans extends org.jooq.impl.TableImpl<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord> {
	...
	private static final long serialVersionUID = -441547555;
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_10> ONE_ZERO = createField("one_zero", org.jooq.impl.SQLDataType.INTEGER, T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_10_Converter());
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_YN_LC> Y_N_LC = createField("y_n_lc", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_YN_LC_Converter());

	/**
	 * The column <code>test.t_booleans.y_n_uc</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord, org.jooq.test.all.converters.Boolean_YN_UC> Y_N_UC = createField("y_n_uc", org.jooq.impl.SQLDataType.CHAR.length(1), T_BOOLEANS, "", new org.jooq.test.all.converters.Boolean_YN_UC_Converter());
	...
	private TBooleans(java.lang.String alias, org.jooq.Table<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord> aliased) {
		this(alias, aliased, null);
	}

	private TBooleans(java.lang.String alias, org.jooq.Table<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.mysql.generatedclasses.tables.records.TBooleansRecord> getPrimaryKey() {
