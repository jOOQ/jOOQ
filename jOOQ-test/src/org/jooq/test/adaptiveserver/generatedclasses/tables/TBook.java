...
public class TBook extends org.jooq.impl.UpdatableTableImpl<org.jooq.test.adaptiveserver.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = 55152466;
	...
	@Override
	@SuppressWarnings("unchecked")
	public java.util.List<org.jooq.ForeignKey<org.jooq.test.adaptiveserver.generatedclasses.tables.records.TBookRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<org.jooq.test.adaptiveserver.generatedclasses.tables.records.TBookRecord, ?>>asList(org.jooq.test.adaptiveserver.generatedclasses.Keys.fk_t_book_author_id, org.jooq.test.adaptiveserver.generatedclasses.Keys.fk_t_book_co_author_id);
	}
}
