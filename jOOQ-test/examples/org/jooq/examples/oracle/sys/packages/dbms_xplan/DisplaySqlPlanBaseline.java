...
public class DisplaySqlPlanBaseline extends org.jooq.impl.AbstractRoutine<org.jooq.examples.oracle.sys.udt.records.DbmsXplanTypeTableRecord> {
	...
	private static final long serialVersionUID = -1843118346;
	 ...
	 */
	public static final org.jooq.Parameter<java.lang.String> SQL_HANDLE = createParameter("SQL_HANDLE", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);

	/**
	 * The parameter <code>SYS.DBMS_XPLAN.DISPLAY_SQL_PLAN_BASELINE.PLAN_NAME</code>. 
	 */
	public static final org.jooq.Parameter<java.lang.String> PLAN_NAME = createParameter("PLAN_NAME", org.jooq.impl.SQLDataType.VARCHAR.defaulted(true), true);
