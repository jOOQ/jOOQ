...
public class PgEnum extends org.jooq.impl.TableImpl<org.jooq.util.postgres.pg_catalog.tables.records.PgEnumRecord> {
	...
	private static final long serialVersionUID = -566842059;
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.postgres.pg_catalog.tables.records.PgEnumRecord, java.lang.Long> ENUMTYPID = createField("enumtypid", org.jooq.impl.SQLDataType.BIGINT, PG_ENUM);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.postgres.pg_catalog.tables.records.PgEnumRecord, java.lang.String> ENUMLABEL = createField("enumlabel", org.jooq.impl.SQLDataType.VARCHAR, PG_ENUM);
