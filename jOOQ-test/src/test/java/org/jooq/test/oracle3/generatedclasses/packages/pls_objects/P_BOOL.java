...
public class P_BOOL extends AbstractRoutine<java.lang.Void> implements Cloneable {

	private static final long serialVersionUID = -952853988;

	/**
	 * The parameter <code>PLS_OBJECTS.P_BOOL.I</code>.
	 */
	...
	/**
	 * The parameter <code>PLS_OBJECTS.P_BOOL.IO</code>.
	 */
	...
	/**
	 * The parameter <code>PLS_OBJECTS.P_BOOL.O</code>.
	 */
	 ...
	 */
	public P_BOOL() {
		super("P_BOOL", DefaultSchema.DEFAULT_SCHEMA, PLS_OBJECTS.PLS_OBJECTS);
