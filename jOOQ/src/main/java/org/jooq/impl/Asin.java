    ...
    MAsin
{
    ...
    @Override
    public final MAsin $number(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MAsin> constructor() {
        return (a1) -> new Asin((Field<? extends Number>) a1);
    }
