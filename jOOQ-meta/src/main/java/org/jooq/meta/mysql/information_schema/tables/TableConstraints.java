...
public class TableConstraints extends TableImpl<Record> {
    ...
    private static final long serialVersionUID = 1815713299;
     ...
     */
    public final TableField<Record, String> CONSTRAINT_TYPE = createField(DSL.name("CONSTRAINT_TYPE"), org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>information_schema.TABLE_CONSTRAINTS.ENFORCED</code>.
     */
    public final TableField<Record, String> ENFORCED = createField(DSL.name("ENFORCED"), org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
