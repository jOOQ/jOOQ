...
public class CheckConstraints extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1309324169;
	...
	public CheckConstraints() {
		super("CHECK_CONSTRAINTS", org.jooq.util.sqlserver.information_schema.InformationSchema.INFORMATION_SCHEMA);
	}
	...
	public CheckConstraints(java.lang.String alias) {
		super(alias, org.jooq.util.sqlserver.information_schema.InformationSchema.INFORMATION_SCHEMA, org.jooq.util.sqlserver.information_schema.tables.CheckConstraints.CHECK_CONSTRAINTS);
	}
	...
	public org.jooq.util.sqlserver.information_schema.tables.CheckConstraints as(java.lang.String alias) {
		return new org.jooq.util.sqlserver.information_schema.tables.CheckConstraints(alias);
	}
}
