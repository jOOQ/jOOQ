...
public interface IVBook extends java.io.Serializable {
	 ...
	 */
	public void from(org.jooq.test.jdbc.generatedclasses.tables.interfaces.IVBook from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface IVBook
	 */
	public <E extends org.jooq.test.jdbc.generatedclasses.tables.interfaces.IVBook> E into(E into);
}
