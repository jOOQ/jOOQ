...
public class Parameters extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 1182810970;
	...
	public Parameters(java.lang.String alias) {
		this(alias, org.jooq.util.sqlserver.information_schema.tables.Parameters.PARAMETERS);
	}
	...
	public org.jooq.util.sqlserver.information_schema.tables.Parameters as(java.lang.String alias) {
		return new org.jooq.util.sqlserver.information_schema.tables.Parameters(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.sqlserver.information_schema.tables.Parameters rename(java.lang.String name) {
		return new org.jooq.util.sqlserver.information_schema.tables.Parameters(name, null);
	}
}
