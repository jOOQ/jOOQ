...
import static org.jooq.impl.Keywords.K_CHECKED;
...
import static org.jooq.impl.Keywords.K_FORCE;
...
import static org.jooq.impl.Keywords.K_INTEGRITY;
...
import static org.jooq.impl.Keywords.K_OFF;
...
import org.jooq.AlterTableAlterConstraintMoreStep;
...
implements
    ...
    AlterTableDropStep,
    AlterTableAlterStep,
    AlterTableAlterConstraintMoreStep,
    ...
    private final void accept0(Context<?> ctx) {
        ...
        if (changeColumnFrom != null && NO_SUPPORT_CHANGE_COLUMN.contains(ctx.dialect())) {
            ...
            if (!nameChange && !identityChange) {
                ...
                // [#12003] In H2, the SET GENERATED BY DEFAULT statement has no effect if it is followed by a SET DATA TYPE statement
                if (ifExistsColumn) {
                    if (nameChange)
