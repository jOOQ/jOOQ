...
public class Columns extends org.jooq.impl.TableImpl<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord> {
	...
	private static final long serialVersionUID = -478026715;
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, java.lang.Long> ORDINAL_POSITION = createField("ORDINAL_POSITION", org.jooq.impl.SQLDataType.BIGINT, COLUMNS);
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, java.lang.Long> CHARACTER_MAXIMUM_LENGTH = createField("CHARACTER_MAXIMUM_LENGTH", org.jooq.impl.SQLDataType.BIGINT, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, java.lang.Long> CHARACTER_OCTET_LENGTH = createField("CHARACTER_OCTET_LENGTH", org.jooq.impl.SQLDataType.BIGINT, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, java.lang.Long> NUMERIC_PRECISION = createField("NUMERIC_PRECISION", org.jooq.impl.SQLDataType.BIGINT, COLUMNS);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.mysql.information_schema.tables.records.ColumnsRecord, java.lang.Long> NUMERIC_SCALE = createField("NUMERIC_SCALE", org.jooq.impl.SQLDataType.BIGINT, COLUMNS);
