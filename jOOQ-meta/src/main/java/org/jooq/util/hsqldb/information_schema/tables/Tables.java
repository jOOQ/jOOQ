...
public class Tables extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = -1661673658;
	...
	public Tables(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.Tables.TABLES);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.Tables as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.Tables(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.hsqldb.information_schema.tables.Tables rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.Tables(name, null);
	}
}
