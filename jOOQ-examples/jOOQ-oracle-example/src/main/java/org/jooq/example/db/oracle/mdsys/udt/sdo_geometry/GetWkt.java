...
public class GetWkt extends AbstractRoutine<String> {

	private static final long serialVersionUID = -1213360062;
	 ...
	 */
	public GetWkt() {
		super("GET_WKT", Mdsys.MDSYS, SdoGeometry.SDO_GEOMETRY, org.jooq.impl.SQLDataType.CLOB);
