...
public class UDateArrayRecord extends org.jooq.impl.ArrayRecordImpl<java.time.LocalDateTime> {
	 ...
	 */
	@java.lang.Deprecated
	public UDateArrayRecord(org.jooq.Configuration configuration, java.time.LocalDateTime... array) {
		this(configuration);
		set(array);
	}
	 ...
	 */
	@java.lang.Deprecated
	public UDateArrayRecord(org.jooq.Configuration configuration, java.util.List<? extends java.time.LocalDateTime> list) {
		this(configuration);
		setList(list);
	}
	 ...
	 * Create a new <code>TEST.U_DATE_ARRAY</code> record
	 */
	public UDateArrayRecord(java.time.LocalDateTime... array) {
		this();
		set(array);
	}
	 ...
	 * Create a new <code>TEST.U_DATE_ARRAY</code> record
	 */
	public UDateArrayRecord(java.util.Collection<? extends java.time.LocalDateTime> collection) {
		this();
		set(collection);
	}
}
