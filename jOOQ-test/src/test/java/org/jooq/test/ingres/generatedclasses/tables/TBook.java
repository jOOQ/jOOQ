...
public class TBook extends org.jooq.impl.TableImpl<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> {
	...
	private static final long serialVersionUID = 774252936;
	 ...
	 */
	public static final org.jooq.TableField<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord, java.lang.Integer> LANGUAGE_ID = createField("language_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaulted(true), T_BOOK, "");
	...
	private TBook(java.lang.String alias, org.jooq.Table<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> aliased) {
		this(alias, aliased, null);
	}

	private TBook(java.lang.String alias, org.jooq.Table<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> aliased, org.jooq.Field<?>[] parameters) {
