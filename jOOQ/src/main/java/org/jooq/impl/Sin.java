    ...
    MSin
{
    ...
    @Override
    public final MSin $number(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MSin> constructor() {
        return (a1) -> new Sin((Field<? extends Number>) a1);
    }
