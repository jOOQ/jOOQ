...
public class XTestCase_71Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.db2.generatedclasses.tables.records.XTestCase_71Record> {
	...
	private static final long serialVersionUID = -1269477792;
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.db2.generatedclasses.tables.records.XTestCase_64_69Record fetchXTestCase_64_69() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.db2.generatedclasses.tables.records.XTestCase_64_69Record getXTestCase_64_69() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.XTestCase_64_69.X_TEST_CASE_64_69)
			.where(org.jooq.test.db2.generatedclasses.tables.XTestCase_64_69.ID.equal(getValueAsInteger(org.jooq.test.db2.generatedclasses.tables.XTestCase_71.TEST_CASE_64_69_ID)))
			.fetchOne();
	...
	public XTestCase_71Record(org.jooq.Configuration configuration) {
		super(org.jooq.test.db2.generatedclasses.tables.XTestCase_71.X_TEST_CASE_71, configuration);
	}
}
