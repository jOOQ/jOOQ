    ...
    MRegrR2
{
    ...
    @Override
    public final MRegrR2 $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MRegrR2 $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MRegrR2> constructor() {
        return (a1, a2) -> new RegrR2((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof RegrR2) {
            return
                StringUtils.equals($y(), ((RegrR2) that).$y()) &&
                StringUtils.equals($x(), ((RegrR2) that).$x())
            ;
        }
        else
