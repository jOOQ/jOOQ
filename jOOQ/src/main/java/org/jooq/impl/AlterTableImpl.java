    ...
    UNotYetImplemented
{
    ...
    static final Clause[]         CLAUSES                               = { ALTER_TABLE };
    static final Set<SQLDialect>  NO_SUPPORT_IF_EXISTS                  = SQLDialect.supportedUntil(CUBRID, DERBY, FIREBIRD, MARIADB);
    ...
    static final Set<SQLDialect>  SUPPORT_RENAME_TABLE                  = SQLDialect.supportedBy(DERBY);
    static final Set<SQLDialect>  NO_SUPPORT_RENAME_QUALIFIED_TABLE     = SQLDialect.supportedBy(DERBY, POSTGRES, YUGABYTEDB);
    static final Set<SQLDialect>  NO_SUPPORT_ALTER_TYPE_AND_NULL        = SQLDialect.supportedBy(POSTGRES, YUGABYTEDB);
    static final Set<SQLDialect>  NO_SUPPORT_DROP_CONSTRAINT            = SQLDialect.supportedBy(MARIADB, MYSQL);
    static final Set<SQLDialect>  REQUIRE_REPEAT_ADD_ON_MULTI_ALTER     = SQLDialect.supportedBy(FIREBIRD, MARIADB, MYSQL, POSTGRES, YUGABYTEDB);
    static final Set<SQLDialect>  REQUIRE_REPEAT_DROP_ON_MULTI_ALTER    = SQLDialect.supportedBy(FIREBIRD, MARIADB, MYSQL, POSTGRES, YUGABYTEDB);
