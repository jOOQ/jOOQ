...
public class VBook extends TableImpl<VBookRecord> {
	...
	private static final long serialVersionUID = -282750094;
	 ...
	 */
	public final TableField<VBookRecord, UBookStatus> STATUS = createField("status", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(org.jooq.test.postgres.generatedclasses.enums.UBookStatus.class), this, "");
