...
public class TUnsignedRecord extends org.jooq.impl.TableRecordImpl<org.jooq.test.informix.generatedclasses.tables.records.TUnsignedRecord> implements org.jooq.Record4<org.jooq.types.UByte, org.jooq.types.UShort, org.jooq.types.UInteger, org.jooq.types.ULong> {

	private static final long serialVersionUID = -240080834;

	/**
	 * Setter for <code>informix.t_unsigned.u_byte</code>.
	 */
	...
	/**
	 * Getter for <code>informix.t_unsigned.u_byte</code>.
	 */
	...
	/**
	 * Setter for <code>informix.t_unsigned.u_short</code>.
	 */
	...
	/**
	 * Getter for <code>informix.t_unsigned.u_short</code>.
	 */
	...
	/**
	 * Setter for <code>informix.t_unsigned.u_int</code>.
	 */
	...
	/**
	 * Getter for <code>informix.t_unsigned.u_int</code>.
	 */
	...
	/**
	 * Setter for <code>informix.t_unsigned.u_long</code>.
	 */
	...
	/**
	 * Getter for <code>informix.t_unsigned.u_long</code>.
	 */
	...
	public org.jooq.Field<org.jooq.types.UByte> field1() {
		return org.jooq.test.informix.generatedclasses.tables.TUnsigned.T_UNSIGNED.U_BYTE;
	}
	...
	public org.jooq.Field<org.jooq.types.UShort> field2() {
		return org.jooq.test.informix.generatedclasses.tables.TUnsigned.T_UNSIGNED.U_SHORT;
	}
	...
	public org.jooq.Field<org.jooq.types.UInteger> field3() {
		return org.jooq.test.informix.generatedclasses.tables.TUnsigned.T_UNSIGNED.U_INT;
	}
	...
	public org.jooq.Field<org.jooq.types.ULong> field4() {
		return org.jooq.test.informix.generatedclasses.tables.TUnsigned.T_UNSIGNED.U_LONG;
	}
	...
	public TUnsignedRecord() {
		super(org.jooq.test.informix.generatedclasses.tables.TUnsigned.T_UNSIGNED);
	}
