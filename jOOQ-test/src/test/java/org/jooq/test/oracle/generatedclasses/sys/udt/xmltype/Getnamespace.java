...
public class Getnamespace extends AbstractRoutine<String> {

	private static final long serialVersionUID = 1975047137;

	/**
	 * The parameter <code>SYS.XMLTYPE.GETNAMESPACE.RETURN_VALUE</code>.
	 */
	public static final Parameter<String> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>SYS.XMLTYPE.GETNAMESPACE.SELF</code>.
	 */
	 ...
	 */
	public Getnamespace() {
		super("GETNAMESPACE", Sys.SYS, Xmltype.XMLTYPE, org.jooq.impl.SQLDataType.VARCHAR);
