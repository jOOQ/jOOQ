...
public class TTriggers extends org.jooq.impl.TableImpl<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord> {
	 ...
	 */
	public static final org.jooq.test.mariadb.generatedclasses.tables.TTriggers T_TRIGGERS = new org.jooq.test.mariadb.generatedclasses.tables.TTriggers();

	/**
	 * The class holding records for this type
	 */
	@Override
	public java.lang.Class<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord> getRecordType() {
		return org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord.class;
	}
	 ...
	 */
	@Override
	public org.jooq.Identity<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord, java.lang.Integer> getIdentity() {
		return org.jooq.test.mariadb.generatedclasses.Keys.IDENTITY_T_TRIGGERS;
	}
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord> getPrimaryKey() {
		return org.jooq.test.mariadb.generatedclasses.Keys.KEY_T_TRIGGERS_PRIMARY;
	}
	 ...
	 */
	@Override
	public java.util.List<org.jooq.UniqueKey<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<org.jooq.test.mariadb.generatedclasses.tables.records.TTriggersRecord>>asList(org.jooq.test.mariadb.generatedclasses.Keys.KEY_T_TRIGGERS_PRIMARY);
	}
}
