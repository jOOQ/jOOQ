...
public class TBookToBookStore extends org.jooq.impl.UpdatableTableImpl<org.jooq.test.firebird.generatedclasses.tables.records.TBookToBookStoreRecord> {
	...
	private static final long serialVersionUID = -1670057841;
	 ...
	 * Create an aliased <code>T_BOOK_TO_BOOK_STORE</code> table reference
	 */
	public TBookToBookStore(java.lang.String alias, java.lang.String... fieldAliases) {
		super(alias, fieldAliases, (org.jooq.Schema) null, org.jooq.test.firebird.generatedclasses.tables.TBookToBookStore.T_BOOK_TO_BOOK_STORE);
	}
	 ...
	 */
	@Override
	public org.jooq.test.firebird.generatedclasses.tables.TBookToBookStore as(java.lang.String alias, java.lang.String... fieldAliases) {
		return new org.jooq.test.firebird.generatedclasses.tables.TBookToBookStore(alias, fieldAliases);
	}
}
