...
public class Proc extends TableImpl<Record> {
     ...
     */
    public static final TableField<Record, ProcType> TYPE = createField("type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcType.class), PROC, "");
     ...
     */
    public static final TableField<Record, ProcLanguage> LANGUAGE = createField("language", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcLanguage.class), PROC, "");

    /**
     * The column <code>mysql.proc.sql_data_access</code>.
     */
    public static final TableField<Record, ProcSqlDataAccess> SQL_DATA_ACCESS = createField("sql_data_access", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcSqlDataAccess.class), PROC, "");

    /**
     * The column <code>mysql.proc.is_deterministic</code>.
     */
    public static final TableField<Record, ProcIsDeterministic> IS_DETERMINISTIC = createField("is_deterministic", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcIsDeterministic.class), PROC, "");

    /**
     * The column <code>mysql.proc.security_type</code>.
     */
    public static final TableField<Record, ProcSecurityType> SECURITY_TYPE = createField("security_type", org.jooq.util.mysql.MySQLDataType.VARCHAR.asEnumDataType(org.jooq.meta.mysql.mysql.enums.ProcSecurityType.class), PROC, "");
