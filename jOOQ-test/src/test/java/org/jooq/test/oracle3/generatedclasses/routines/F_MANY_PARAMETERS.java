...
public class F_MANY_PARAMETERS extends AbstractRoutine<BigDecimal> implements Cloneable {

	private static final long serialVersionUID = 1457258971;

	/**
	 * The parameter <code>F_MANY_PARAMETERS.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public F_MANY_PARAMETERS() {
		super("F_MANY_PARAMETERS", DefaultSchema.DEFAULT_SCHEMA, org.jooq.impl.SQLDataType.NUMERIC);
