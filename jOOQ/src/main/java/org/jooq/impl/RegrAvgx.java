    ...
    MRegrAvgx
{
    ...
    @Override
    public final MRegrAvgx $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MRegrAvgx $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MRegrAvgx> constructor() {
        return (a1, a2) -> new RegrAvgx((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof RegrAvgx) {
            return
                StringUtils.equals($y(), ((RegrAvgx) that).$y()) &&
                StringUtils.equals($x(), ((RegrAvgx) that).$x())
            ;
        }
        else
