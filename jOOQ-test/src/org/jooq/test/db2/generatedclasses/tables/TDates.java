...
public class TDates extends org.jooq.impl.TableImpl<org.jooq.test.db2.generatedclasses.tables.records.TDatesRecord> {

	private static final long serialVersionUID = -1883579132;

	/**
	 * The singleton instance of <code>LIBRARY.T_DATES</code>
	 */
	...
	/**
	 * The column <code>LIBRARY.T_DATES.ID</code>.
	 */
	public static final org.jooq.TableField<org.jooq.test.db2.generatedclasses.tables.records.TDatesRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), T_DATES, "");

	/**
	 * The column <code>LIBRARY.T_DATES.D</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_DATES.T</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_DATES.TS</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_DATES.D_INT</code>.
	 */
	...
	/**
	 * The column <code>LIBRARY.T_DATES.TS_BIGINT</code>.
	 */
	...
	private TDates(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.TDatesRecord> aliased) {
		this(alias, aliased, null);
	}

	private TDates(java.lang.String alias, org.jooq.Table<org.jooq.test.db2.generatedclasses.tables.records.TDatesRecord> aliased, org.jooq.Field<?>[] parameters) {
	 ...
	 */
	@Override
	public org.jooq.UniqueKey<org.jooq.test.db2.generatedclasses.tables.records.TDatesRecord> getPrimaryKey() {
