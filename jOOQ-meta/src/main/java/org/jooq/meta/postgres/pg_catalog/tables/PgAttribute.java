...
public class PgAttribute extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, Short> ATTNDIMS = createField(DSL.name("attndims"), SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public final TableField<Record, Short> ATTINHCOUNT = createField(DSL.name("attinhcount"), SQLDataType.SMALLINT.nullable(false), this, "");
     ...
     */
    public final TableField<Record, Short> ATTSTATTARGET = createField(DSL.name("attstattarget"), SQLDataType.SMALLINT, this, "");
