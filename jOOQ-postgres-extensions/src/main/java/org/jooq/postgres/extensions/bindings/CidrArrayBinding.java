 ...
 * @author Lukas Eder
 */
public class CidrArrayBinding extends AbstractPostgresArrayBinding<Cidr> {

    private static final Converter<Object[], Cidr[]> CONVERTER = new CidrConverter().forArrays();
