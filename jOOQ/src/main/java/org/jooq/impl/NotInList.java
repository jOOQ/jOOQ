...
final class NotInList<T> extends AbstractInList<T> implements QOM.NotInList<T> {
    ...
    NotInList(Field<T> field, List<? extends Field<?>> values) {
        super(field, values);
    }
    ...
    @Override
    public final Function2<? super Field<T>, ? super UnmodifiableList<? extends Field<T>>, ? extends QOM.NotInList<T>> $constructor() {
