...
public class FManyParameters extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -2064377424;
	...
	public FManyParameters() {
		super("f_many_parameters", Dbo.DBO, org.jooq.impl.SQLDataType.INTEGER);
