...
public class SystemColumns extends TableImpl<Record> {
    ...
    private SystemColumns(Name alias, Table<Record> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("the visible columns of each accessible table defined within this database"), TableOptions.table(), where);
    }
    ...
    @Override
    public SystemColumns as(Table<?> alias) {
        return new SystemColumns(alias.getQualifiedName(), this);
    }
}
