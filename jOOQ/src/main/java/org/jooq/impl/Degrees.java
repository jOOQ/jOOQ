    ...
    MDegrees
{
    ...
    @Override
    public final Field<? extends Number> $radians() {
        return radians;
    }

    @Override
    public final MDegrees $radians(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MDegrees> constructor() {
