...
/**
 * The <code>BIN TO UUID</code> statement.
 */
    ...
    QOM.BinToUuid
{
    ...
    public final void accept(Context<?> ctx) {
        switch (ctx.family()) {
            ...
            case CLICKHOUSE:
                ctx.visit(function(N_UUIDNumToString, UUID, bytes));
                break;
    ...
    public boolean equals(Object that) {
        if (that instanceof QOM.BinToUuid o) {
            return
