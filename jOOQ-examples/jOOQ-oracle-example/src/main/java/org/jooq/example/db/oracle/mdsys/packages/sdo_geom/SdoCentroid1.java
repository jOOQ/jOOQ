...
public class SdoCentroid1 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = -1513544769;

	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_CENTROID.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_CENTROID.GEOM1</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_CENTROID.DIM1</code>.
	 */
	 ...
	 */
	public SdoCentroid1() {
		super("SDO_CENTROID", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.packages.SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoCentroid1.GEOM1, value);
	}
	...
	public void setDim1(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoCentroid1.DIM1, value);
	}
