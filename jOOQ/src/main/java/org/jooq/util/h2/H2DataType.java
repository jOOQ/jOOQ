...
public class H2DataType {
    ...
    public static final DataType<byte[]>            BINARYVARYING                = new DefaultDataType<>(FAMILY, SQLDataType.VARBINARY, "binary varying(l)");
    ...
    public static final DataType<String>            CHARVARYING                  = new DefaultDataType<>(FAMILY, SQLDataType.VARCHAR, "char varying(l)");
    ...
    public static final DataType<String>            CHARLARGEOBJECT              = new DefaultDataType<>(FAMILY, SQLDataType.CLOB, "char large object");
    ...
    public static final DataType<String>            NATIONALCHARVARYING          = new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "national char varying(l)");
    public static final DataType<String>            NATIONALCHARACTERVARYING     = new DefaultDataType<>(FAMILY, SQLDataType.NVARCHAR, "national character varying(l)");
    public static final DataType<String>            NCHAR                        = new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "nchar(l)");
    public static final DataType<String>            NATIONALCHAR                 = new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "national char(l)");
    public static final DataType<String>            NATIONALCHARACTER            = new DefaultDataType<>(FAMILY, SQLDataType.NCHAR, "national character(l)");
    public static final DataType<String>            NCLOB                        = new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "nclob");
    public static final DataType<String>            NCHARLARGEOBJECT             = new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "nchar large object");
    public static final DataType<String>            NATIONALCHARLARGEOBJECT      = new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "national char large object");
    public static final DataType<String>            NATIONALCHARACTERLARGEOBJECT = new DefaultDataType<>(FAMILY, SQLDataType.NCLOB, "national character large object");
