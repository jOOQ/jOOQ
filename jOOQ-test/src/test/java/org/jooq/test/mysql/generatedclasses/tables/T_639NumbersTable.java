...
public class T_639NumbersTable extends TableImpl<T_639NumbersTableRecord> {
	...
	private static final long serialVersionUID = 1783759714;
	 ...
	 */
	public static final TableField<T_639NumbersTableRecord, Double> FLOAT = createField("FLOAT", org.jooq.impl.SQLDataType.FLOAT, T_639_NUMBERS_TABLE, "");
	...
	public List<UniqueKey<T_639NumbersTableRecord>> getKeys() {
		return Arrays.<UniqueKey<T_639NumbersTableRecord>>asList(Keys.KEY_T_639_NUMBERS_TABLE_PRIMARY);
	}
}
