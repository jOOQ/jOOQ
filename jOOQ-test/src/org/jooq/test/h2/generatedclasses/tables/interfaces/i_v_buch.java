...
public interface i_v_buch extends java.io.Serializable, java.lang.Cloneable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface i_v_buch
	 */
	public void from(org.jooq.test.h2.generatedclasses.tables.interfaces.i_v_buch from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface i_v_buch
	 */
	public <E extends org.jooq.test.h2.generatedclasses.tables.interfaces.i_v_buch> E into(E into);
}
