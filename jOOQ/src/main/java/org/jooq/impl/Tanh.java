    ...
    MTanh
{
    ...
    @Override
    public final MTanh $number(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MTanh> constructor() {
        return (a1) -> new Tanh((Field<? extends Number>) a1);
    }
