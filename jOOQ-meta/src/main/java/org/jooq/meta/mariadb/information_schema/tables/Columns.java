 ...
 */
package org.jooq.meta.mariadb.information_schema.tables;
...
import org.jooq.meta.mariadb.information_schema.InformationSchema;
...
public class Columns extends TableImpl<Record> {
     ...
     */
    public final TableField<Record, String> TABLE_CATALOG = createField(DSL.name("TABLE_CATALOG"), SQLDataType.VARCHAR(512).nullable(false), this, "");
     ...
     */
    public final TableField<Record, String> IS_NULLABLE = createField(DSL.name("IS_NULLABLE"), SQLDataType.VARCHAR(3).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.DATA_TYPE</code>.
     */
    public final TableField<Record, String> DATA_TYPE = createField(DSL.name("DATA_TYPE"), SQLDataType.VARCHAR(64).nullable(false), this, "");
     ...
     */
    public final TableField<Record, String> EXTRA = createField(DSL.name("EXTRA"), SQLDataType.VARCHAR(80).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.PRIVILEGES</code>.
     */
    public final TableField<Record, String> PRIVILEGES = createField(DSL.name("PRIVILEGES"), SQLDataType.VARCHAR(80).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.COLUMN_COMMENT</code>.
     */
    public final TableField<Record, String> COLUMN_COMMENT = createField(DSL.name("COLUMN_COMMENT"), SQLDataType.VARCHAR(1024).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.IS_GENERATED</code>.
     */
    public final TableField<Record, String> IS_GENERATED = createField(DSL.name("IS_GENERATED"), SQLDataType.VARCHAR(6).nullable(false), this, "");

    /**
     * The column <code>information_schema.COLUMNS.GENERATION_EXPRESSION</code>.
     */
    public final TableField<Record, String> GENERATION_EXPRESSION = createField(DSL.name("GENERATION_EXPRESSION"), SQLDataType.CLOB, this, "");

    /**
     * The column
     * <code>information_schema.COLUMNS.IS_SYSTEM_TIME_PERIOD_START</code>.
     */
    public final TableField<Record, String> IS_SYSTEM_TIME_PERIOD_START = createField(DSL.name("IS_SYSTEM_TIME_PERIOD_START"), SQLDataType.VARCHAR(3).nullable(false), this, "");

    /**
     * The column
     * <code>information_schema.COLUMNS.IS_SYSTEM_TIME_PERIOD_END</code>.
     */
    public final TableField<Record, String> IS_SYSTEM_TIME_PERIOD_END = createField(DSL.name("IS_SYSTEM_TIME_PERIOD_END"), SQLDataType.VARCHAR(3).nullable(false), this, "");
