...
public class PostgresJSONJacksonBinding implements Binding<Object, JSONJacksonHelloWorld> {
    ...
    @Override
    public void register(BindingRegisterContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        ctx.statement().registerOutParameter(ctx.index(), Types.VARCHAR);
    }

    @Override
    public void set(BindingSetStatementContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        ctx.statement().setString(ctx.index(), convert(ctx.convert(converter()).value(), String.class));
    }

    @Override
    public void get(BindingGetResultSetContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        ctx.convert(converter()).value(ctx.resultSet().getString(ctx.index()));
    }

    @Override
    public void get(BindingGetStatementContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        ctx.convert(converter()).value(ctx.statement().getString(ctx.index()));
    }

    @Override
    public void set(BindingSetSQLOutputContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        throw new SQLFeatureNotSupportedException();
    }

    @Override
    public void get(BindingGetSQLInputContext<JSONJacksonHelloWorld> ctx) throws SQLException {
        throw new SQLFeatureNotSupportedException();
    }
}
