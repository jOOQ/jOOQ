...
public class GetDims extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal> {

	private static final long serialVersionUID = -1708077859;

	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_DIMS.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_DIMS.SELF</code>.
	 */
	 ...
	 */
	public GetDims() {
		super("GET_DIMS", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY, org.jooq.impl.SQLDataType.NUMERIC);
	...
	public void setSelf(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.GetDims.SELF, value);
	}
