...
public class PUnused extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1766193950;

	/**
	 * The parameter <code>LIBRARY.P_UNUSED.IN1</code>.
	 */
	 ...
	 */
	public PUnused() {
		super("P_UNUSED", org.jooq.test.db2.generatedclasses.Library.LIBRARY);
