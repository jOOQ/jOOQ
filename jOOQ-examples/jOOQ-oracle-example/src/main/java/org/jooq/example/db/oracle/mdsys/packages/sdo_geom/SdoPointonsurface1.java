...
public class SdoPointonsurface1 extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = 920919211;
	...
	public SdoPointonsurface1() {
		super("SDO_POINTONSURFACE", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
