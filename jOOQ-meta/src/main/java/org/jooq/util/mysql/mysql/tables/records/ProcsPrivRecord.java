...
public class ProcsPrivRecord extends org.jooq.impl.TableRecordImpl<org.jooq.util.mysql.mysql.tables.records.ProcsPrivRecord> {
	...
	private static final long serialVersionUID = 956075793;
	 ...
	 */
	@Deprecated
	public ProcsPrivRecord(org.jooq.Configuration configuration) {
		super(org.jooq.util.mysql.mysql.tables.ProcsPriv.PROCS_PRIV, configuration);
	}
}
