...
public class PResults extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = 1785509914;

	/**
	 * The parameter <code>dbo.p_results.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public PResults() {
		super("p_results", Dbo.DBO, org.jooq.impl.SQLDataType.INTEGER);
