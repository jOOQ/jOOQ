...
public class TBookStore extends org.jooq.impl.TableImpl<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord> {
	...
	private static final long serialVersionUID = 901091429;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord, java.lang.String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR.length(400).nullable(false), this, "The books store name");
	...
	public TBookStore(java.lang.String alias) {
		this(alias, org.jooq.test.mysql2.generatedclasses.tables.TBookStore.T_BOOK_STORE);
	}
	...
	private TBookStore(java.lang.String alias, org.jooq.Table<org.jooq.test.mysql2.generatedclasses.tables.records.TBookStoreRecord> aliased, org.jooq.Field<?>[] parameters) {
		super(alias, org.jooq.test.mysql2.generatedclasses.Test2.TEST2, aliased, parameters, "A book store");
	}
