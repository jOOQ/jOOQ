...
public class TestTransitive extends AbstractRoutine<NumberObjectRecord> {
	...
	private static final long serialVersionUID = -1550379970;
	...
	public TestTransitive() {
		super("TEST_TRANSITIVE", Test.TEST, TestSynonymPackage.TEST_SYNONYM_PACKAGE, org.jooq.test.oracle.generatedclasses.multi_schema.udt.NumberObject.NUMBER_OBJECT.getDataType());
