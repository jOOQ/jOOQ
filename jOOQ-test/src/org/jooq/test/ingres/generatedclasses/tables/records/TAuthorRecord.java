...
public class TAuthorRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.ingres.generatedclasses.tables.records.TAuthorRecord> {
	...
	private static final long serialVersionUID = 1684979837;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> fetchTBookListByAuthorId() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> getTBookListByAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.ingres.generatedclasses.tables.TBook.AUTHOR_ID.equal(getValue(org.jooq.test.ingres.generatedclasses.tables.TAuthor.ID)))
			.fetch();
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> fetchTBookListByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TBook.T_BOOK)
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.ingres.generatedclasses.tables.records.TBookRecord> getTBookListByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.ingres.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.ingres.generatedclasses.tables.TBook.CO_AUTHOR_ID.equal(getValue(org.jooq.test.ingres.generatedclasses.tables.TAuthor.ID)))
			.fetch();
	...
	public TAuthorRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.ingres.generatedclasses.tables.TAuthor.T_AUTHOR, configuration);
	}
}
