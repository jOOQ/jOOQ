...
public class P391 extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = -1864433690;
	 ...
	 */
	public P391() {
		super("P391", org.jooq.test.oracle5.generatedclasses.Test.TEST);
	 ...
	 */
	public void setI1(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.P391.I1, value);
	}

	/**
	 * Set the <code>IO1</code> parameter IN value to the routine
	 */
	public void setIo1(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.P391.IO1, value);
	}

	/**
	 * Set the <code>IO2</code> parameter IN value to the routine
	 */
	public void setIo2(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.P391.IO2, value);
	}

	/**
	 * Set the <code>I2</code> parameter IN value to the routine
	 */
	public void setI2(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.P391.I2, value);
	}
