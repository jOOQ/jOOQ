...
public interface Row11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> extends Row, SelectField<Record11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> {
     ...
     * deconstruction over the {@link Record11}'s individual component values.
     * <p>
     ...
     * some deconstruction over the {@link Record11}'s individual component
     * values.
     * <p>
     * Combine this with e.g. {@link Functions#nullOnAllNull(Function11)} or
     * {@link Functions#nullOnAnyNull(Function11)} to achieve <code>null</code>
     ...
     */
    @NotNull
    <U> SelectField<U> mapping(Class<U> uType, Function11<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? super T10, ? super T11, ? extends U> function);
