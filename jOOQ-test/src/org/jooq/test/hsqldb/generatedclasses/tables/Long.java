...
public class Long extends org.jooq.impl.TableImpl<org.jooq.test.hsqldb.generatedclasses.tables.records.LongRecord> {
	...
	private static final long serialVersionUID = 682524707;
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.test.hsqldb.generatedclasses.tables.records.LongRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER, LONG);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.test.hsqldb.generatedclasses.tables.records.LongRecord, java.lang.Long> OTHER = createField("OTHER", org.jooq.impl.SQLDataType.BIGINT, LONG);
