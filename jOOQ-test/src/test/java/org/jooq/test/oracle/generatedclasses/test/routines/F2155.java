...
public class F2155 extends org.jooq.impl.AbstractRoutine<java.sql.Date> {

	private static final long serialVersionUID = 74250837;
	 ...
	 */
	public F2155() {
		super("F2155", org.jooq.test.oracle.generatedclasses.test.Test.TEST, org.jooq.impl.SQLDataType.DATE);
	 ...
	 */
	public void setP2(org.jooq.Field<java.sql.Date> field) {
		setField(P2, field);
	}
	 ...
	 */
	public void setP4(java.sql.Date value) {
	 ...
	 */
	public void setP4(org.jooq.Field<java.sql.Date> field) {
		setField(P4, field);
	}
}
