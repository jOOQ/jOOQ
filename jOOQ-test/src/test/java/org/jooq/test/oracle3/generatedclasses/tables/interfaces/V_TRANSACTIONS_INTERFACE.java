...
public interface V_TRANSACTIONS_INTERFACE extends java.lang.Cloneable, java.io.Serializable {
	...
	/**
	 * Load data from another generated Record/POJO implementing the common interface V_TRANSACTIONS_INTERFACE
	 */
	public void from(org.jooq.test.oracle3.generatedclasses.tables.interfaces.V_TRANSACTIONS_INTERFACE from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface V_TRANSACTIONS_INTERFACE
	 */
