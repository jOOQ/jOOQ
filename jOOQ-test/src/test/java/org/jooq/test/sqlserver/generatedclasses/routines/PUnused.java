...
public class PUnused extends AbstractRoutine<Integer> {

	private static final long serialVersionUID = -21781387;

	/**
	 * The parameter <code>dbo.p_unused.RETURN_VALUE</code>.
	 */
	 ...
	 */
	public PUnused() {
		super("p_unused", Dbo.DBO, org.jooq.impl.SQLDataType.INTEGER);
