...
public class PUnused extends org.jooq.impl.AbstractRoutine<java.lang.Void> {
	...
	private static final long serialVersionUID = 906676639;
	 ...
	 */
	public PUnused() {
		super("P_UNUSED", org.jooq.test.oracle5.generatedclasses.Test.TEST);
	...
	public void setIn1(java.lang.String value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.PUnused.IN1, value);
	}

	/**
	 * Set the <code>OUT2</code> parameter IN value to the routine
	 */
	public void setOut2(java.math.BigDecimal value) {
		setValue(org.jooq.test.oracle5.generatedclasses.routines.PUnused.OUT2, value);
	}
