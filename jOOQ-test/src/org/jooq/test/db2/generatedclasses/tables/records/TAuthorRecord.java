...
public class TAuthorRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.db2.generatedclasses.tables.records.TAuthorRecord> {
	...
	private static final long serialVersionUID = -1336647549;
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.TBookRecord> getTBookListByAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.db2.generatedclasses.tables.TBook.AUTHOR_ID.equal(getValue(org.jooq.test.db2.generatedclasses.tables.TAuthor.ID)))
			.fetch();
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.db2.generatedclasses.tables.records.TBookRecord> getTBookListByCoAuthorId() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.db2.generatedclasses.tables.TBook.T_BOOK)
			.where(org.jooq.test.db2.generatedclasses.tables.TBook.CO_AUTHOR_ID.equal(getValue(org.jooq.test.db2.generatedclasses.tables.TAuthor.ID)))
			.fetch();
