...
final class MetaSQL {
    ...
    static {
        ...
        M_COMMENTS.put(CLICKHOUSE, "select c.database, c.database, c.name, c.name, c.comment from (select system.tables.database, system.tables.database, system.tables.name, null name, system.tables.comment from system.tables where system.tables.comment <> '' union all select system.columns.database, system.columns.database, system.columns.table, system.columns.name, system.columns.comment from system.columns where system.columns.comment <> '') c where c.database in (?) order by 1, 2, 3, 4");
