...
public class Deletexml extends AbstractRoutine<XmltypeRecord> {

	private static final long serialVersionUID = 1797918312;

	/**
	 * The parameter <code>SYS.XMLTYPE.DELETEXML.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.DELETEXML.SELF</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.DELETEXML.XPATH</code>.
	 */
	public static final Parameter<String> XPATH = createParameter("XPATH", org.jooq.impl.SQLDataType.VARCHAR, false);

	/**
	 * The parameter <code>SYS.XMLTYPE.DELETEXML.NAMESPACE</code>.
	 */
	 ...
	 */
	public Deletexml() {
		super("DELETEXML", Sys.SYS, Xmltype.XMLTYPE, org.jooq.test.oracle.generatedclasses.sys.udt.Xmltype.XMLTYPE.getDataType());
