 ...
 * This class is generated by jOOQ.
 */
class FAuthorExists extends AbstractRoutine[BigDecimal]("F_AUTHOR_EXISTS", Test.TEST, org.jooq.impl.SQLDataType.NUMERIC) {
	{
		setReturnParameter(FAuthorExists.RETURN_VALUE)
		addInParameter(FAuthorExists.AUTHOR_NAME)
	}
	...
	def setAuthorName(value : String) : Unit = {
		setValue(FAuthorExists.AUTHOR_NAME, value)
	}
	...
	def setAuthorName(field : Field[String]) : Unit = {
		setField(FAuthorExists.AUTHOR_NAME, field)
	}
}
