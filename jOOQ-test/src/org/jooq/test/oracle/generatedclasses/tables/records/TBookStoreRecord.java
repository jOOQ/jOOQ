...
public class TBookStoreRecord extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.oracle.generatedclasses.tables.records.TBookStoreRecord> {
	...
	private static final long serialVersionUID = 1917525529;

	/**
	 * The books store name
	 */
	public void setName(java.lang.String value) {
		setValue(org.jooq.test.oracle.generatedclasses.tables.TBookStore.NAME, value);
	}
	...
	public java.lang.String getName() {
		return getValue(org.jooq.test.oracle.generatedclasses.tables.TBookStore.NAME);
	}
	...
	public java.util.List<org.jooq.test.oracle.generatedclasses.tables.records.TBookToBookStoreRecord> fetchTBookToBookStoreList() throws java.sql.SQLException {
		return create()
			...
			.where(org.jooq.test.oracle.generatedclasses.tables.TBookToBookStore.BOOK_STORE_NAME.equal(getValue(org.jooq.test.oracle.generatedclasses.tables.TBookStore.NAME)))
			.fetch();
	}
	...
	public TBookStoreRecord(org.jooq.Configuration configuration) {
		super(org.jooq.test.oracle.generatedclasses.tables.TBookStore.T_BOOK_STORE, configuration);
	}
}
