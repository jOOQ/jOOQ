...
public interface Database extends AutoCloseable {
    ...
    /**
     * Whether <code>GENERATED BY DEFAULT AS IDENTITY</code> columns should
     * expose {@link DataType#readonly()} behaviour.
     * <p>
     * This feature is available in the commercial distribution only.
     */
    boolean readonlyGeneratedByDefaultIdentities();
     ...
     * This feature is available in the commercial distribution only.
     */
    void setReadonlyGeneratedByDefaultIdentities(boolean readonlyGeneratedByDefaultIdentities);

    /**
     * Whether <code>GENERATED ALWAYS AS IDENTITY</code> columns should
     * expose {@link DataType#readonly()} behaviour.
     * <p>
     * This feature is available in the commercial distribution only.
     */
    boolean readonlyGeneratedAlwaysIdentities();
     ...
     * This feature is available in the commercial distribution only.
     */
    void setReadonlyGeneratedAlwaysIdentities(boolean readonlyGeneratedAlwaysIdentities);
