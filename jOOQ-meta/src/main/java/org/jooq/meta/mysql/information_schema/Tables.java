...
public class Tables {
     ...
     */
    public static final Columns COLUMNS = org.jooq.meta.mysql.information_schema.tables.Columns.COLUMNS;

    /**
     * The table <code>information_schema.KEY_COLUMN_USAGE</code>.
     */
    public static final KeyColumnUsage KEY_COLUMN_USAGE = org.jooq.meta.mysql.information_schema.tables.KeyColumnUsage.KEY_COLUMN_USAGE;

    /**
     * The table <code>information_schema.PARAMETERS</code>.
     */
    public static final Parameters PARAMETERS = org.jooq.meta.mysql.information_schema.tables.Parameters.PARAMETERS;

    /**
     * The table <code>information_schema.REFERENTIAL_CONSTRAINTS</code>.
     */
    public static final ReferentialConstraints REFERENTIAL_CONSTRAINTS = org.jooq.meta.mysql.information_schema.tables.ReferentialConstraints.REFERENTIAL_CONSTRAINTS;

    /**
     * The table <code>information_schema.ROUTINES</code>.
     */
    public static final Routines ROUTINES = org.jooq.meta.mysql.information_schema.tables.Routines.ROUTINES;

    /**
     * The table <code>information_schema.SCHEMATA</code>.
     */
    public static final Schemata SCHEMATA = org.jooq.meta.mysql.information_schema.tables.Schemata.SCHEMATA;

    /**
     * The table <code>information_schema.STATISTICS</code>.
     */
    public static final Statistics STATISTICS = org.jooq.meta.mysql.information_schema.tables.Statistics.STATISTICS;
     ...
     */
    public static final TableConstraints TABLE_CONSTRAINTS = org.jooq.meta.mysql.information_schema.tables.TableConstraints.TABLE_CONSTRAINTS;
}
