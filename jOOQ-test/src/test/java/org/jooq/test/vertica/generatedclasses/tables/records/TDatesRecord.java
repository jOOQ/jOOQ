...
public class TDatesRecord extends UpdatableRecordImpl<TDatesRecord> implements Record8<Long, Date, Time, Timestamp, Long, Long, YearToMonth, Object>, ITDates {

	private static final long serialVersionUID = -306968981;
	 ...
	 */
	@Override
	public Row8<Long, Date, Time, Timestamp, Long, Long, YearToMonth, Object> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<Long, Date, Time, Timestamp, Long, Long, YearToMonth, Object> valuesRow() {
	 ...
	 */
	@Override
	public TDatesRecord value1(Long value) {
		setId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TDatesRecord values(Long value1, Date value2, Time value3, Timestamp value4, Long value5, Long value6, YearToMonth value7, Object value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TDatesRecord(Long id, Date d, Time t, Timestamp ts, Long dInt, Long tsBigint, YearToMonth iY, Object iD) {
		super(TDates.T_DATES);
