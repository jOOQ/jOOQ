    ...
    MRegrSlope
{
    ...
    @Override
    public final MRegrSlope $y(MField<? extends Number> newValue) {
        return constructor().apply(newValue, $x());
    }

    @Override
    public final MRegrSlope $x(MField<? extends Number> newValue) {
        return constructor().apply($y(), newValue);
    }

    public final Function2<? super MField<? extends Number>, ? super MField<? extends Number>, ? extends MRegrSlope> constructor() {
        return (a1, a2) -> new RegrSlope((Field<? extends Number>) a1, (Field<? extends Number>) a2);
    }
