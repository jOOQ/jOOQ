...
import org.jooq.test.vertica.generatedclasses.tables.interfaces.ITBooleans;
...
public class TBooleansRecord extends UpdatableRecordImpl<TBooleansRecord> implements Record11<Long, Boolean_10, Boolean_TF_LC, Boolean_TF_UC, Boolean_YES_NO_LC, Boolean_YES_NO_UC, Boolean_YN_LC, Boolean_YN_UC, Boolean, Boolean, Boolean>, ITBooleans {

	private static final long serialVersionUID = -1968184973;
	 ...
	 */
	@Override
	public Row11<Long, Boolean_10, Boolean_TF_LC, Boolean_TF_UC, Boolean_YES_NO_LC, Boolean_YES_NO_UC, Boolean_YN_LC, Boolean_YN_UC, Boolean, Boolean, Boolean> fieldsRow() {
	 ...
	 */
	@Override
	public Row11<Long, Boolean_10, Boolean_TF_LC, Boolean_TF_UC, Boolean_YES_NO_LC, Boolean_YES_NO_UC, Boolean_YN_LC, Boolean_YN_UC, Boolean, Boolean, Boolean> valuesRow() {
	 ...
	 */
	@Override
	public TBooleansRecord value1(Long value) {
		setId(value);
		return this;
	}
	 ...
	 */
	@Override
	public TBooleansRecord values(Long value1, Boolean_10 value2, Boolean_TF_LC value3, Boolean_TF_UC value4, Boolean_YES_NO_LC value5, Boolean_YES_NO_UC value6, Boolean_YN_LC value7, Boolean_YN_UC value8, Boolean value9, Boolean value10, Boolean value11) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TBooleansRecord(Long id, Boolean_10 oneZero, Boolean_TF_LC trueFalseLc, Boolean_TF_UC trueFalseUc, Boolean_YES_NO_LC yesNoLc, Boolean_YES_NO_UC yesNoUc, Boolean_YN_LC yNLc, Boolean_YN_UC yNUc, Boolean vcBoolean, Boolean cBoolean, Boolean nBoolean) {
		super(TBooleans.T_BOOLEANS);
