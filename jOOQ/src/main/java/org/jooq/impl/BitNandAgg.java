...
extends
    AbstractAggregateFunction<T, QOM.BitNandAgg<T>>
implements
    QOM.BitNandAgg<T>
{
    ...
    @Override
    final QOM.BitNandAgg<T> copyAggregateFunction(Function<? super QOM.BitNandAgg<T>, ? extends QOM.BitNandAgg<T>> function) {
