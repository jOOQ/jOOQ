...
public class XUnused extends org.jooq.impl.TableImpl<org.jooq.test.oracle.generatedclasses.test.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = 1913635733;
...
"Its comments contain special characters"
	 */
	public final org.jooq.TableField<org.jooq.test.oracle.generatedclasses.test.tables.records.XUnusedRecord, java.lang.Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "An unused column of an unused table in the same schema. \n\n\"Its comments contain special characters\"");

	/**
	 * The column <code>TEST.X_UNUSED.NAME</code>.
	 */
	public final org.jooq.TableField<org.jooq.test.oracle.generatedclasses.test.tables.records.XUnusedRecord, java.lang.String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(10).nullable(false), this, "");
	...
	public XUnused(java.lang.String alias) {
		this(alias, org.jooq.test.oracle.generatedclasses.test.tables.XUnused.X_UNUSED);
	}
	...
	private XUnused(java.lang.String alias, org.jooq.Table<org.jooq.test.oracle.generatedclasses.test.tables.records.XUnusedRecord> aliased, org.jooq.Field<?>[] parameters) {
		super(alias, org.jooq.test.oracle.generatedclasses.test.Test.TEST, aliased, parameters, "An unused table in the same schema. \n\n\"Its comments contain special characters\"");
	}
