...
/**
 * A converter for the PostgreSQL <code>ltree</code> data type.
 *
 * @author Lukas Eder
 */
public class LtreeConverter extends AbstractConverter<Object, Ltree> {
    ...
    @Override
    public Ltree from(Object t) {
        return t == null ? null : Ltree.ltree("" + t);
    }

    @Override
    public Object to(Ltree u) {
        return u == null ? null : u.data();
    }
}
