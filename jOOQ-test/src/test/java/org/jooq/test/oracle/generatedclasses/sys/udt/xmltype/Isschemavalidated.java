...
public class Isschemavalidated extends AbstractRoutine<BigDecimal> {

	private static final long serialVersionUID = 1877709448;

	/**
	 * The parameter <code>SYS.XMLTYPE.ISSCHEMAVALIDATED.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>SYS.XMLTYPE.ISSCHEMAVALIDATED.SELF</code>.
	 */
	 ...
	 */
	public Isschemavalidated() {
		super("ISSCHEMAVALIDATED", Sys.SYS, Xmltype.XMLTYPE, org.jooq.impl.SQLDataType.NUMERIC);
