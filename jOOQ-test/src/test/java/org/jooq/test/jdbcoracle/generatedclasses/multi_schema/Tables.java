...
public class Tables {
	 ...
	 */
	public static final TAuthor T_AUTHOR = org.jooq.test.jdbcoracle.generatedclasses.multi_schema.tables.TAuthor.T_AUTHOR;

	/**
	 * The table MULTI_SCHEMA.T_BOOK
	 */
	public static final TBook T_BOOK = org.jooq.test.jdbcoracle.generatedclasses.multi_schema.tables.TBook.T_BOOK;

	/**
	 * The table MULTI_SCHEMA.T_BOOK_SALE
	 */
	public static final TBookSale T_BOOK_SALE = org.jooq.test.jdbcoracle.generatedclasses.multi_schema.tables.TBookSale.T_BOOK_SALE;
}
