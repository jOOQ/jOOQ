    ...
    MGt<T>
{
    ...
    @Override
    public final MGt<T> $arg1(MField<T> newValue) {
        return constructor().apply(newValue, $arg2());
    }

    @Override
    public final MGt<T> $arg2(MField<T> newValue) {
        return constructor().apply($arg1(), newValue);
    }

    @Override
    public final Function2<? super MField<T>, ? super MField<T>, ? extends MGt<T>> constructor() {
        return (a1, a2) -> new Gt<>((Field<T>) a1, (Field<T>) a2);
    }
