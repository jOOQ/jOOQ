...
import org.jooq.test.vertica.generatedclasses.tables.records.T_785Record;
...
public class T_785 extends TableImpl<T_785Record> {
	 ...
	 */
	public final TableField<T_785Record, String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(50).defaulted(true), this, "");

	/**
	 * The column <code>public.t_785.VALUE</code>.
	 */
	public final TableField<T_785Record, String> VALUE = createField("VALUE", org.jooq.impl.SQLDataType.VARCHAR.length(50).defaulted(true), this, "");
