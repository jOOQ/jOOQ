...
public interface ITPerformanceJooq extends Serializable {
	 ...
	 */
	public void from(org.jooq.test.h2.generatedclasses.tables.interfaces.ITPerformanceJooq from);

	/**
	 * Copy data into another generated Record/POJO implementing the common interface ITPerformanceJooq
	 */
	public <E extends org.jooq.test.h2.generatedclasses.tables.interfaces.ITPerformanceJooq> E into(E into);
}
