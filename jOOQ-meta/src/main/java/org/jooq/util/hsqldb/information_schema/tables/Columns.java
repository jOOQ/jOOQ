...
public class Columns extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	private static final long serialVersionUID = 2067909884;
	...
	public Columns(java.lang.String alias) {
		this(alias, org.jooq.util.hsqldb.information_schema.tables.Columns.COLUMNS);
	}
	...
	public org.jooq.util.hsqldb.information_schema.tables.Columns as(java.lang.String alias) {
		return new org.jooq.util.hsqldb.information_schema.tables.Columns(alias, this);
	}

	/**
	 * Rename this table
	 */
	public org.jooq.util.hsqldb.information_schema.tables.Columns rename(java.lang.String name) {
		return new org.jooq.util.hsqldb.information_schema.tables.Columns(name, null);
	}
}
