...
public class UStreetType extends org.jooq.impl.UDTImpl<org.jooq.test.oracle5.generatedclasses.udt.records.UStreetTypeRecord> {
	 ...
	 */
	public static final org.jooq.test.oracle5.generatedclasses.udt.UStreetType U_STREET_TYPE = new org.jooq.test.oracle5.generatedclasses.udt.UStreetType();

	/**
	 * The class holding records for this type
	 */
	@Override
	public java.lang.Class<org.jooq.test.oracle5.generatedclasses.udt.records.UStreetTypeRecord> getRecordType() {
		return org.jooq.test.oracle5.generatedclasses.udt.records.UStreetTypeRecord.class;
	}
	 ...
	 */
	private UStreetType() {
		super("U_STREET_TYPE", org.jooq.test.oracle5.generatedclasses.Test.TEST);
