...
public class XTestCase_64_69Record extends org.jooq.impl.UpdatableRecordImpl<org.jooq.test.h2.generatedclasses.tables.records.XTestCase_64_69Record> {

	private static final long serialVersionUID = -1440027977;
	 ...
	 * PRIMARY KEY
	 */
	public java.util.List<org.jooq.test.h2.generatedclasses.tables.records.XTestCase_71Record> fetchXTestCase_71List() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public java.util.List<org.jooq.test.h2.generatedclasses.tables.records.XTestCase_71Record> getXTestCase_71List() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.h2.generatedclasses.tables.XTestCase_71.X_TEST_CASE_71)
			.where(org.jooq.test.h2.generatedclasses.tables.XTestCase_71.TEST_CASE_64_69_ID.equal(getValueAsShort(org.jooq.test.h2.generatedclasses.tables.XTestCase_64_69.ID)))
			.fetch();
	 ...
	 * </pre></code>
	 */
	public org.jooq.test.h2.generatedclasses.tables.records.XUnusedRecord fetchXUnused() throws java.sql.SQLException {
		return create()
	 ...
	 */
	@Deprecated
	public org.jooq.test.h2.generatedclasses.tables.records.XUnusedRecord getXUnused() throws java.sql.SQLException {
		return create()
			.selectFrom(org.jooq.test.h2.generatedclasses.tables.XUnused.X_UNUSED)
			.where(org.jooq.test.h2.generatedclasses.tables.XUnused.ID.equal(getValue(org.jooq.test.h2.generatedclasses.tables.XTestCase_64_69.UNUSED_ID)))
			.fetchOne();
	...
	public XTestCase_64_69Record(org.jooq.Configuration configuration) {
		super(org.jooq.test.h2.generatedclasses.tables.XTestCase_64_69.X_TEST_CASE_64_69, configuration);
	}
}
