    ...
    MStddevPop
{
    ...
    @Override
    public final MStddevPop $field(MField<? extends Number> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<? extends Number>, ? extends MStddevPop> constructor() {
        return (a1) -> new StddevPop((Field<? extends Number>) a1);
    }
