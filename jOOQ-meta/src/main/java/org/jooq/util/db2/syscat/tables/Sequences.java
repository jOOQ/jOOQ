...
public class Sequences extends org.jooq.impl.TableImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord> {
	 ...
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal> INCREMENT = new org.jooq.impl.TableFieldImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal>("INCREMENT", org.jooq.impl.SQLDataType.DECIMAL, SEQUENCES);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal> START = new org.jooq.impl.TableFieldImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal>("START", org.jooq.impl.SQLDataType.DECIMAL, SEQUENCES);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal> MAXVALUE = new org.jooq.impl.TableFieldImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal>("MAXVALUE", org.jooq.impl.SQLDataType.DECIMAL, SEQUENCES);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal> MINVALUE = new org.jooq.impl.TableFieldImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal>("MINVALUE", org.jooq.impl.SQLDataType.DECIMAL, SEQUENCES);

	/**
	 * An uncommented item
	 */
	public static final org.jooq.TableField<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal> NEXTCACHEFIRSTVALUE = new org.jooq.impl.TableFieldImpl<org.jooq.util.db2.syscat.tables.records.SequencesRecord, java.math.BigDecimal>("NEXTCACHEFIRSTVALUE", org.jooq.impl.SQLDataType.DECIMAL, SEQUENCES);
