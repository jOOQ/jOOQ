...
public class ObjectFactory {
    ...
    private final static QName _Settings_QNAME = new QName("http://www.jooq.org/xsd/jooq-runtime-3.12.4.xsd", "settings");
     ...
     */
    @XmlElementDecl(namespace = "http://www.jooq.org/xsd/jooq-runtime-3.12.4.xsd", name = "settings")
