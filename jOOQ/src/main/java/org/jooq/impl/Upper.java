    ...
    MUpper
{
    ...
    @Override
    public final MUpper $string(MField<String> newValue) {
        return constructor().apply(newValue);
    }

    public final Function1<? super MField<String>, ? extends MUpper> constructor() {
        return (a1) -> new Upper((Field<String>) a1);
    }
