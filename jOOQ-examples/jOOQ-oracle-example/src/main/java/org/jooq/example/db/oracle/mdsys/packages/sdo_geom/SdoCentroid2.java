...
public class SdoCentroid2 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = -1577945587;
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOM.SDO_CENTROID.TOL</code>.
	 */
	...
	public void setGeom1(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoCentroid2.GEOM1, value);
	}
	...
	public void setTol(java.lang.Number value) {
		setNumber(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoCentroid2.TOL, value);
	}
