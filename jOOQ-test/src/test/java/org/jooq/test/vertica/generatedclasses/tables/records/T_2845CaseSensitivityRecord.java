...
public class T_2845CaseSensitivityRecord extends UpdatableRecordImpl<T_2845CaseSensitivityRecord> implements Record5<Integer, Long, Long, Long, Long>, IT_2845CaseSensitivity {

	private static final long serialVersionUID = -2036615839;
	 ...
	 */
	@Override
	public T_2845CaseSensitivityRecord values(Integer value1, Long value2, Long value3, Long value4, Long value5) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public T_2845CaseSensitivityRecord(Integer id, Long insensitive, Long upper, Long lower, Long mixed) {
		super(T_2845CaseSensitivity.T_2845_CASE_SENSITIVITY);
