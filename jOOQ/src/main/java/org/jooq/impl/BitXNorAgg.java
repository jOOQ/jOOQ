...
extends
    AbstractAggregateFunction<T, QOM.BitXNorAgg<T>>
implements
    QOM.BitXNorAgg<T>
{
    ...
    @Override
    final QOM.BitXNorAgg<T> copyAggregateFunction(Function<? super QOM.BitXNorAgg<T>, ? extends QOM.BitXNorAgg<T>> function) {
