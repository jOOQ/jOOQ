...
public class MyFactory extends org.jooq.util.oracle.OracleFactory implements java.lang.Cloneable {
	...
	private static final long serialVersionUID = 451227309;
	 ...
	 */
	public MyFactory(javax.sql.DataSource dataSource) {
		super(dataSource);
	 ...
	 * @param settings The settings to apply to objects created from this factory
	 */
	public MyFactory(javax.sql.DataSource dataSource, org.jooq.conf.Settings settings) {
