...
public class SdoGeometry3 extends org.jooq.impl.AbstractRoutine<org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord> {

	private static final long serialVersionUID = -347924708;
	 ...
	 */
	public static final org.jooq.Parameter<byte[]> WKB = createParameter("WKB", org.jooq.impl.SQLDataType.BLOB, false);
	...
	public void setSelf(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.SdoGeometry3.SELF, value);
	}
	...
	public void setWkb(byte[] value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.SdoGeometry3.WKB, value);
	}
	...
	public void setSrid(java.math.BigInteger value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.SdoGeometry3.SRID, value);
	}
