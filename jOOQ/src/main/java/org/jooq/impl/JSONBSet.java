...
/**
 * The <code>JSONB SET</code> statement.
 */
@SuppressWarnings({ "rawtypes", "unchecked", "unused" })
final class JSONBSet
extends
    AbstractField<JSONB>
implements
    QOM.JSONBSet
{
    ...
    @Override
    public final QOM.JSONBSet $field(Field<JSONB> newValue) {
        return $constructor().apply(newValue, $path(), $value());
    }

    @Override
    public final QOM.JSONBSet $path(Field<String> newValue) {
        return $constructor().apply($field(), newValue, $value());
    }

    @Override
    public final QOM.JSONBSet $value(Field<?> newValue) {
    ...
    public final Function3<? super Field<JSONB>, ? super Field<String>, ? super Field<?>, ? extends QOM.JSONBSet> $constructor() {
        return (a1, a2, a3) -> new JSONBSet(a1, a2, a3);
    }
    ...
    public boolean equals(Object that) {
        if (that instanceof QOM.JSONBSet o) {
            return
