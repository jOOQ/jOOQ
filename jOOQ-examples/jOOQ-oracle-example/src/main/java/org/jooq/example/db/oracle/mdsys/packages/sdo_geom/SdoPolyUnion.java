...
public class SdoPolyUnion extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = -1617464859;
	 ...
	 */
	public SdoPolyUnion() {
		super("SDO_POLY_UNION", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
