...
public class SdoG3dconv1 extends AbstractRoutine<SdoGeometryRecord> {

	private static final long serialVersionUID = -555035795;
	 ...
	 */
	public SdoG3dconv1() {
		super("SDO_G3DCONV", Mdsys.MDSYS, SdoGeom.SDO_GEOM, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY.getDataType());
