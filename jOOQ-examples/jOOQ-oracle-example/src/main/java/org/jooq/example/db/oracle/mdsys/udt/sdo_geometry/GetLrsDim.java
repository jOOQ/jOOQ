...
public class GetLrsDim extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal> {

	private static final long serialVersionUID = -1143512344;

	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_LRS_DIM.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>MDSYS.SDO_GEOMETRY.GET_LRS_DIM.SELF</code>.
	 */
	 ...
	 */
	public GetLrsDim() {
		super("GET_LRS_DIM", org.jooq.example.db.oracle.mdsys.Mdsys.MDSYS, org.jooq.example.db.oracle.mdsys.udt.SdoGeometry.SDO_GEOMETRY, org.jooq.impl.SQLDataType.NUMERIC);
	...
	public void setSelf(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.udt.sdo_geometry.GetLrsDim.SELF, value);
	}
