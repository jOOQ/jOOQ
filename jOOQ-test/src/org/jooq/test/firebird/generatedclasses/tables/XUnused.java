...
public class XUnused extends org.jooq.impl.TableImpl<org.jooq.test.firebird.generatedclasses.tables.records.XUnusedRecord> {
	...
	private static final long serialVersionUID = -650686003;
	 ...
	 */
	public final org.jooq.TableField<org.jooq.test.firebird.generatedclasses.tables.records.XUnusedRecord, java.lang.String> NAME = createField("NAME", org.jooq.impl.SQLDataType.VARCHAR.length(10), this);
	 ...
	 */
	public XUnused() {
		super("X_UNUSED", org.jooq.test.firebird.generatedclasses.DefaultSchema.DEFAULT_SCHEMA);
	}
	...
	public XUnused(java.lang.String alias) {
		super(alias, org.jooq.test.firebird.generatedclasses.DefaultSchema.DEFAULT_SCHEMA, org.jooq.test.firebird.generatedclasses.tables.XUnused.X_UNUSED);
	}
