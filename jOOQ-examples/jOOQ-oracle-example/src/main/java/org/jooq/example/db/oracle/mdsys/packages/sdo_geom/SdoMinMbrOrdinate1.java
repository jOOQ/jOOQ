...
public class SdoMinMbrOrdinate1 extends org.jooq.impl.AbstractRoutine<java.math.BigDecimal> {

	private static final long serialVersionUID = 1780786495;
	...
	public void setGeom(org.jooq.example.db.oracle.mdsys.udt.records.SdoGeometryRecord value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoMinMbrOrdinate1.GEOM, value);
	}
	...
	public void setDim(java.lang.Object value) {
		setValue(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoMinMbrOrdinate1.DIM, value);
	}
	...
	public void setOrdinatePos(java.lang.Number value) {
		setNumber(org.jooq.example.db.oracle.mdsys.packages.sdo_geom.SdoMinMbrOrdinate1.ORDINATE_POS, value);
	}
