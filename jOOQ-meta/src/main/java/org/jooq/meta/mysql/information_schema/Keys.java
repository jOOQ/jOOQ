...
public class Keys {
    ...
    public static final UniqueKey<Record> SYNTHETIC_PK_ROUTINES = Internal.createUniqueKey(Routines.ROUTINES, DSL.name("SYNTHETIC_PK_ROUTINES"), new TableField[] { Routines.ROUTINES.SPECIFIC_NAME }, true);
