...
extends BaseTest<A, AP, B, S, B2S, BS, L, X, DATE, BOOL, D, T, U, UU, CS, I, IPK, T725, T639, T785, CASE> {
    ...
    public ResultSetTests(jOOQAbstractTest<A, AP, B, S, B2S, BS, L, X, DATE, BOOL, D, T, U, UU, CS, I, IPK, T725, T639, T785, CASE> delegate) {
        super(delegate);
    }
    ...
    public void testResultSetConcurrency() throws Exception {
        ...
        assertEquals(
            ...
            create(new DefaultExecuteListener() {
                ...
                public void recordStart(ExecuteContext ctx) {
                    try {
                        ...
                        ctx.resultSet().updateString(2, "Title " + (++repeat));
            ...
            // Some databases (e.g. Oracle) require an explicit FOR UPDATE
            .forUpdate()
